...
public class ConvoManagerScript : MonoBehaviour
{
	...
	public void LateUpdate()
	{
		...
		if (studentScript != null && studentScript.Alive && !studentScript.Alarmed && studentScript.ClubAttire && studentScript.CurrentAction == StudentActionType.ClubAction && Vector3.Distance(studentScript.transform.position, SM.Clubs.List[MartialArtist[1]].position) < 1.5f)
		{
