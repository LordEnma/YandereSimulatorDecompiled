...
{
	// Token: 0x0600146D RID: 5229 RVA: 0x000C6B77 File Offset: 0x000C4D77
	private void Start()
	{
		this.Subtitle.transform.localScale = new Vector3(0f, 0f, 0f);
	}

	// Token: 0x0600146E RID: 5230 RVA: 0x000C6BA0 File Offset: 0x000C4DA0
	private void Update()
	{
		if (!this.GameOver)
		{
	...
	// Token: 0x0600146F RID: 5231 RVA: 0x000C73BC File Offset: 0x000C55BC
	...
	// Token: 0x06001470 RID: 5232 RVA: 0x000C7408 File Offset: 0x000C5608
	...
	// Token: 0x06001471 RID: 5233 RVA: 0x000C74D4 File Offset: 0x000C56D4
	...
	// Token: 0x06001472 RID: 5234 RVA: 0x000C75B4 File Offset: 0x000C57B4
