...
{
	// Token: 0x0600146D RID: 5229 RVA: 0x000C6C07 File Offset: 0x000C4E07
	private void Start()
	{
		this.Subtitle.transform.localScale = new Vector3(0f, 0f, 0f);
	}

	// Token: 0x0600146E RID: 5230 RVA: 0x000C6C30 File Offset: 0x000C4E30
	private void Update()
	{
		if (!this.GameOver)
		{
	...
	// Token: 0x0600146F RID: 5231 RVA: 0x000C744C File Offset: 0x000C564C
	...
	// Token: 0x06001470 RID: 5232 RVA: 0x000C7498 File Offset: 0x000C5698
	...
	// Token: 0x06001471 RID: 5233 RVA: 0x000C7564 File Offset: 0x000C5764
	...
	// Token: 0x06001472 RID: 5234 RVA: 0x000C7644 File Offset: 0x000C5844
