...
public class ZoomScript : MonoBehaviour
{
	...
	private void Update()
	{
		...
		else if (Yandere.Slender || Yandere.Stand.Stand.activeInHierarchy || Yandere.Blasting || Yandere.PK || Yandere.Shipgirl || TallHat.activeInHierarchy || Yandere.Man.activeInHierarchy || Yandere.Pod.activeInHierarchy || Yandere.LucyHelmet.activeInHierarchy || Yandere.Kagune[0].activeInHierarchy || Yandere.Demonic || Yandere.FloppyHat.activeInHierarchy)
		{
