...
public static class OptionGlobals
{
	...
	// (get) Token: 0x0600162B RID: 5675 RVA: 0x000DBE88 File Offset: 0x000DA088
	// (set) Token: 0x0600162C RID: 5676 RVA: 0x000DBEB4 File Offset: 0x000DA0B4
	...
	// (get) Token: 0x0600162D RID: 5677 RVA: 0x000DBEE0 File Offset: 0x000DA0E0
	// (set) Token: 0x0600162E RID: 5678 RVA: 0x000DBF0C File Offset: 0x000DA10C
	...
	// (get) Token: 0x0600162F RID: 5679 RVA: 0x000DBF38 File Offset: 0x000DA138
	// (set) Token: 0x06001630 RID: 5680 RVA: 0x000DBF64 File Offset: 0x000DA164
	...
	// (get) Token: 0x06001631 RID: 5681 RVA: 0x000DBF90 File Offset: 0x000DA190
	// (set) Token: 0x06001632 RID: 5682 RVA: 0x000DBFBC File Offset: 0x000DA1BC
	...
	// (get) Token: 0x06001633 RID: 5683 RVA: 0x000DBFE8 File Offset: 0x000DA1E8
	// (set) Token: 0x06001634 RID: 5684 RVA: 0x000DC014 File Offset: 0x000DA214
	...
	// (get) Token: 0x06001635 RID: 5685 RVA: 0x000DC040 File Offset: 0x000DA240
	// (set) Token: 0x06001636 RID: 5686 RVA: 0x000DC06C File Offset: 0x000DA26C
	...
	// (get) Token: 0x06001637 RID: 5687 RVA: 0x000DC098 File Offset: 0x000DA298
	// (set) Token: 0x06001638 RID: 5688 RVA: 0x000DC0C4 File Offset: 0x000DA2C4
	...
	// (get) Token: 0x06001639 RID: 5689 RVA: 0x000DC0F0 File Offset: 0x000DA2F0
	// (set) Token: 0x0600163A RID: 5690 RVA: 0x000DC11C File Offset: 0x000DA31C
	...
	// (get) Token: 0x0600163B RID: 5691 RVA: 0x000DC148 File Offset: 0x000DA348
	// (set) Token: 0x0600163C RID: 5692 RVA: 0x000DC174 File Offset: 0x000DA374
	...
	// (get) Token: 0x0600163D RID: 5693 RVA: 0x000DC1A0 File Offset: 0x000DA3A0
	// (set) Token: 0x0600163E RID: 5694 RVA: 0x000DC1CC File Offset: 0x000DA3CC
	...
	// (get) Token: 0x0600163F RID: 5695 RVA: 0x000DC1F8 File Offset: 0x000DA3F8
	// (set) Token: 0x06001640 RID: 5696 RVA: 0x000DC224 File Offset: 0x000DA424
	...
	// (get) Token: 0x06001641 RID: 5697 RVA: 0x000DC250 File Offset: 0x000DA450
	// (set) Token: 0x06001642 RID: 5698 RVA: 0x000DC27C File Offset: 0x000DA47C
	...
	// (get) Token: 0x06001643 RID: 5699 RVA: 0x000DC2A8 File Offset: 0x000DA4A8
	// (set) Token: 0x06001644 RID: 5700 RVA: 0x000DC2D4 File Offset: 0x000DA4D4
	...
	// (get) Token: 0x06001645 RID: 5701 RVA: 0x000DC300 File Offset: 0x000DA500
	// (set) Token: 0x06001646 RID: 5702 RVA: 0x000DC32C File Offset: 0x000DA52C
	...
	// (get) Token: 0x06001647 RID: 5703 RVA: 0x000DC358 File Offset: 0x000DA558
	// (set) Token: 0x06001648 RID: 5704 RVA: 0x000DC384 File Offset: 0x000DA584
	...
	// (get) Token: 0x06001649 RID: 5705 RVA: 0x000DC3B0 File Offset: 0x000DA5B0
	// (set) Token: 0x0600164A RID: 5706 RVA: 0x000DC3DC File Offset: 0x000DA5DC
	...
	// (get) Token: 0x0600164B RID: 5707 RVA: 0x000DC408 File Offset: 0x000DA608
	// (set) Token: 0x0600164C RID: 5708 RVA: 0x000DC434 File Offset: 0x000DA634
	...
	// (get) Token: 0x0600164D RID: 5709 RVA: 0x000DC460 File Offset: 0x000DA660
	// (set) Token: 0x0600164E RID: 5710 RVA: 0x000DC48C File Offset: 0x000DA68C
	...
	// (get) Token: 0x0600164F RID: 5711 RVA: 0x000DC4B8 File Offset: 0x000DA6B8
	// (set) Token: 0x06001650 RID: 5712 RVA: 0x000DC4E4 File Offset: 0x000DA6E4
	...
	// (get) Token: 0x06001651 RID: 5713 RVA: 0x000DC510 File Offset: 0x000DA710
	// (set) Token: 0x06001652 RID: 5714 RVA: 0x000DC53C File Offset: 0x000DA73C
	...
	// (get) Token: 0x06001653 RID: 5715 RVA: 0x000DC568 File Offset: 0x000DA768
	// (set) Token: 0x06001654 RID: 5716 RVA: 0x000DC594 File Offset: 0x000DA794
	...
	// (get) Token: 0x06001655 RID: 5717 RVA: 0x000DC5C0 File Offset: 0x000DA7C0
	// (set) Token: 0x06001656 RID: 5718 RVA: 0x000DC5EC File Offset: 0x000DA7EC
	...
	// (get) Token: 0x06001657 RID: 5719 RVA: 0x000DC618 File Offset: 0x000DA818
	// (set) Token: 0x06001658 RID: 5720 RVA: 0x000DC644 File Offset: 0x000DA844
	...
	// (get) Token: 0x06001659 RID: 5721 RVA: 0x000DC670 File Offset: 0x000DA870
	// (set) Token: 0x0600165A RID: 5722 RVA: 0x000DC69C File Offset: 0x000DA89C
	...
	// (get) Token: 0x0600165B RID: 5723 RVA: 0x000DC6C8 File Offset: 0x000DA8C8
	// (set) Token: 0x0600165C RID: 5724 RVA: 0x000DC6F4 File Offset: 0x000DA8F4
	...
	// (get) Token: 0x0600165D RID: 5725 RVA: 0x000DC720 File Offset: 0x000DA920
	// (set) Token: 0x0600165E RID: 5726 RVA: 0x000DC74C File Offset: 0x000DA94C
	...
	// (get) Token: 0x0600165F RID: 5727 RVA: 0x000DC778 File Offset: 0x000DA978
	// (set) Token: 0x06001660 RID: 5728 RVA: 0x000DC7A4 File Offset: 0x000DA9A4
	...
	// (get) Token: 0x06001661 RID: 5729 RVA: 0x000DC7D0 File Offset: 0x000DA9D0
	// (set) Token: 0x06001662 RID: 5730 RVA: 0x000DC7FC File Offset: 0x000DA9FC
	...
	// (get) Token: 0x06001663 RID: 5731 RVA: 0x000DC828 File Offset: 0x000DAA28
	// (set) Token: 0x06001664 RID: 5732 RVA: 0x000DC854 File Offset: 0x000DAA54
	...
	// (get) Token: 0x06001665 RID: 5733 RVA: 0x000DC880 File Offset: 0x000DAA80
	// (set) Token: 0x06001666 RID: 5734 RVA: 0x000DC8AC File Offset: 0x000DAAAC
	...
	// (get) Token: 0x06001667 RID: 5735 RVA: 0x000DC8D8 File Offset: 0x000DAAD8
	// (set) Token: 0x06001668 RID: 5736 RVA: 0x000DC904 File Offset: 0x000DAB04
	...
	// (get) Token: 0x06001669 RID: 5737 RVA: 0x000DC930 File Offset: 0x000DAB30
	// (set) Token: 0x0600166A RID: 5738 RVA: 0x000DC95C File Offset: 0x000DAB5C
	...
	// (get) Token: 0x0600166B RID: 5739 RVA: 0x000DC988 File Offset: 0x000DAB88
	// (set) Token: 0x0600166C RID: 5740 RVA: 0x000DC9B4 File Offset: 0x000DABB4
	...
	// (get) Token: 0x0600166D RID: 5741 RVA: 0x000DC9E0 File Offset: 0x000DABE0
	// (set) Token: 0x0600166E RID: 5742 RVA: 0x000DCA0C File Offset: 0x000DAC0C
	...
	// (get) Token: 0x0600166F RID: 5743 RVA: 0x000DCA38 File Offset: 0x000DAC38
	// (set) Token: 0x06001670 RID: 5744 RVA: 0x000DCA64 File Offset: 0x000DAC64
	...
	// (get) Token: 0x06001671 RID: 5745 RVA: 0x000DCA90 File Offset: 0x000DAC90
	// (set) Token: 0x06001672 RID: 5746 RVA: 0x000DCABC File Offset: 0x000DACBC
	...
	// (get) Token: 0x06001673 RID: 5747 RVA: 0x000DCAE8 File Offset: 0x000DACE8
	// (set) Token: 0x06001674 RID: 5748 RVA: 0x000DCB14 File Offset: 0x000DAD14
	...
	// (get) Token: 0x06001675 RID: 5749 RVA: 0x000DCB40 File Offset: 0x000DAD40
	// (set) Token: 0x06001676 RID: 5750 RVA: 0x000DCB6C File Offset: 0x000DAD6C
	...
	// Token: 0x06001677 RID: 5751 RVA: 0x000DCB98 File Offset: 0x000DAD98
