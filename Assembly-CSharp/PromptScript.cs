...
{
	// Token: 0x06001B03 RID: 6915 RVA: 0x0012BCF0 File Offset: 0x00129EF0
	private void Awake()
	{
	...
	// Token: 0x06001B04 RID: 6916 RVA: 0x0012C431 File Offset: 0x0012A631
	private void Start()
	{
	...
	// Token: 0x06001B05 RID: 6917 RVA: 0x0012C448 File Offset: 0x0012A648
	...
	// Token: 0x06001B06 RID: 6918 RVA: 0x0012C45B File Offset: 0x0012A65B
	private bool AllowedWhenCrouching(PromptOwnerType ownerType)
	{
		return ownerType == PromptOwnerType.Door;
	}

	// Token: 0x06001B07 RID: 6919 RVA: 0x0012C461 File Offset: 0x0012A661
	private bool AllowedWhenCrawling(PromptOwnerType ownerType)
	{
		return false;
	}

	// Token: 0x06001B08 RID: 6920 RVA: 0x0012C464 File Offset: 0x0012A664
	private void Update()
	{
	...
	// Token: 0x06001B09 RID: 6921 RVA: 0x0012D208 File Offset: 0x0012B408
	private void OnBecameVisible()
	{
		this.InView = true;
	}

	// Token: 0x06001B0A RID: 6922 RVA: 0x0012D211 File Offset: 0x0012B411
	...
	// Token: 0x06001B0B RID: 6923 RVA: 0x0012D220 File Offset: 0x0012B420
	public void Hide()
	{
		if (!this.Hidden)
		{
