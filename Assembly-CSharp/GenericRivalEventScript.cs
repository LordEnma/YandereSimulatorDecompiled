...
{
	// Token: 0x060014DD RID: 5341 RVA: 0x000D0A78 File Offset: 0x000CEC78
	private void Start()
	{
		...
		if (DateGlobals.Week > 1)
		{
			...
			else if (this.EventDay == DayOfWeek.Friday)
			{
				if (week == 2)
				{
	...
	// Token: 0x060014DE RID: 5342 RVA: 0x000D4C0C File Offset: 0x000D2E0C
	private void Update()
	{
		if (this.Phase == 0)
		{
			if (this.Senpai == null && this.Rival == null)
			{
	...
	// Token: 0x060014DF RID: 5343 RVA: 0x000D5670 File Offset: 0x000D3870
	public void EndEvent()
	{
		...
		if (this.Teleport && this.NaturalEnd)
		{
			...
			if (DateGlobals.Weekday == DayOfWeek.Thursday)
			{
				...
				if (this.Rival.StudentID != 15 && this.Rival.ScheduleBlocks.Length == 10)
				{
					ScheduleBlock scheduleBlock3 = this.Rival.ScheduleBlocks[6];
	...
	// Token: 0x060014E0 RID: 5344 RVA: 0x000D5AC8 File Offset: 0x000D3CC8
