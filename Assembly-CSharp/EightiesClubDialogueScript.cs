...
public class EightiesClubDialogueScript : MonoBehaviour
{
	...
	public string folderPath = "CustomMode/ClubLeaders/";
	...
	private void LoadClubLeaderSubtitles()
	{
		string path = Path.Combine(Application.streamingAssetsPath, folderPath);
		for (int i = 1; i < fileNames.Length; i++)
		{
			string path2 = fileNames[i] + ".txt";
				...
				foreach (string text2 in array)
				{
					if (!string.IsNullOrWhiteSpace(text2))
					{
						...
						if (array2.Length >= 2)
						{
							...
							AssignToSubtitleVariable(i, key, value);
						}
					}
				}
			}
	...
	private void AssignToSubtitleVariable(int clubID, string key, string value)
	{
		switch (key)
		{
		case "Greeting":
			Subtitle.ClubGreetings[clubID] = value;
			break;
		case "Unwelcome":
			Subtitle.ClubUnwelcomes[clubID] = value;
			break;
		case "Kick":
			Subtitle.ClubKicks[clubID] = value;
			break;
		case "Join":
			Subtitle.ClubJoins[clubID] = value;
			break;
		case "Accept":
			Subtitle.ClubAccepts[clubID] = value;
			break;
		case "Refuse":
			Subtitle.ClubRefuses[clubID] = value;
			break;
		case "Rejoin":
			Subtitle.ClubRejoins[clubID] = value;
			break;
		case "Exclusive":
			Subtitle.ClubExclusives[clubID] = value;
			break;
		case "Grudge":
			Subtitle.ClubGrudges[clubID] = value;
			break;
		case "Quit":
			Subtitle.ClubQuits[clubID] = value;
			break;
		case "Confirm":
			Subtitle.ClubConfirms[clubID] = value;
			break;
		case "Deny":
			Subtitle.ClubDenies[clubID] = value;
			break;
		case "Farewell":
			Subtitle.ClubFarewells[clubID] = value;
			break;
		case "Activity":
			Subtitle.ClubActivities[clubID] = value;
			break;
		case "Early":
			Subtitle.ClubEarlies[clubID] = value;
			break;
		case "Late":
			Subtitle.ClubLates[clubID] = value;
			break;
		case "Yes":
			Subtitle.ClubYeses[clubID] = value;
			break;
		case "No":
			Subtitle.ClubNoes[clubID] = value;
			break;
		default:
			Debug.LogWarning($"Unknown key: {key} in file for ClubID {clubID}");
			break;
		}
	}
	...
	private void LoadClubInfo()
	{
		...
		for (int i = 1; i < fileNames.Length; i++)
		{
			...
			if (File.Exists(text))
			{
				...
				AssignToClubInfoVariable(i, array2);
			}
			else
			{
				Debug.LogError("File not found: " + text);
	...
	private void AssignToClubInfoVariable(int clubID, string[] clubInfo)
	{
		switch (clubID)
		{
		case 1:
			Subtitle.Club1Info[1] = clubInfo[0];
			Subtitle.Club1Info[2] = clubInfo[1];
			Subtitle.Club1Info[3] = clubInfo[2];
			break;
		case 2:
			Subtitle.Club2Info[1] = clubInfo[0];
			Subtitle.Club2Info[2] = clubInfo[1];
			Subtitle.Club2Info[3] = clubInfo[2];
			break;
		case 3:
			Subtitle.Club3Info[1] = clubInfo[0];
			Subtitle.Club3Info[2] = clubInfo[1];
			Subtitle.Club3Info[3] = clubInfo[2];
			break;
		case 4:
			Subtitle.Club4Info[1] = clubInfo[0];
			Subtitle.Club4Info[2] = clubInfo[1];
			Subtitle.Club4Info[3] = clubInfo[2];
			break;
		case 5:
			Subtitle.Club5Info[1] = clubInfo[0];
			Subtitle.Club5Info[2] = clubInfo[1];
			Subtitle.Club5Info[3] = clubInfo[2];
			break;
		case 6:
			Subtitle.Club6Info[1] = clubInfo[0];
			Subtitle.Club6Info[2] = clubInfo[1];
			Subtitle.Club6Info[3] = clubInfo[2];
			break;
		case 7:
			Subtitle.Club7InfoLight[1] = clubInfo[0];
			Subtitle.Club7InfoLight[2] = clubInfo[1];
			Subtitle.Club7InfoLight[3] = clubInfo[2];
			Subtitle.Club7InfoDark[1] = clubInfo[0];
			Subtitle.Club7InfoDark[2] = clubInfo[1];
			Subtitle.Club7InfoDark[3] = clubInfo[2];
			break;
		case 8:
			Subtitle.Club8Info[1] = clubInfo[0];
			Subtitle.Club8Info[2] = clubInfo[1];
			Subtitle.Club8Info[3] = clubInfo[2];
			break;
		case 9:
			Subtitle.Club9Info[1] = clubInfo[0];
			Subtitle.Club9Info[2] = clubInfo[1];
			Subtitle.Club9Info[3] = clubInfo[2];
			break;
		case 10:
			Subtitle.Club10Info[1] = clubInfo[0];
			Subtitle.Club10Info[2] = clubInfo[1];
			Subtitle.Club10Info[3] = clubInfo[2];
			break;
		case 11:
			Subtitle.Club11Info[1] = clubInfo[0];
			Subtitle.Club11Info[2] = clubInfo[1];
			Subtitle.Club11Info[3] = clubInfo[2];
			break;
		case 12:
			Subtitle.Club12Info[1] = clubInfo[0];
			Subtitle.Club12Info[2] = clubInfo[1];
			Subtitle.Club12Info[3] = clubInfo[2];
			break;
		case 13:
			Subtitle.Club13Info[1] = clubInfo[0];
			Subtitle.Club13Info[2] = clubInfo[1];
			Subtitle.Club13Info[3] = clubInfo[2];
			break;
		}
	}
}
