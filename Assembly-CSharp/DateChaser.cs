...
{
	// Token: 0x0600132B RID: 4907 RVA: 0x000AAECC File Offset: 0x000A90CC
	private static DateTime fromUnix(long unix)
	{
		return DateChaser.epoch.AddSeconds((double)unix);
	}

	// Token: 0x0600132C RID: 4908 RVA: 0x000AAEE8 File Offset: 0x000A90E8
	private void Start()
	{
	...
	// Token: 0x0600132D RID: 4909 RVA: 0x000AAEFC File Offset: 0x000A90FC
	private void Update()
	{
		if (this.Animate)
		{
	...
	// Token: 0x0600132E RID: 4910 RVA: 0x000AB03D File Offset: 0x000A923D
