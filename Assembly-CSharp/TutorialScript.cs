...
{
	// Token: 0x06001EFA RID: 7930 RVA: 0x001B3DB4 File Offset: 0x001B1FB4
	private void Start()
	{
	...
	// Token: 0x06001EFB RID: 7931 RVA: 0x001B4194 File Offset: 0x001B2394
	private void Update()
	{
			...
			else
			{
				...
				else if (this.CutscenePhase == 9)
				{
					...
					if (this.MyAudio.time > this.MyAudio.clip.length - 0.2f && !this.Yandere.RPGCamera.enabled)
					{
						...
						CosmeticScript cosmetic2 = this.StudentManager.Students[2].Cosmetic;
						cosmetic2.FaceTexture = cosmetic2.HairRenderer.material.mainTexture;
						cosmetic2.RightEyeRenderer.material.mainTexture = cosmetic2.FaceTexture;
						cosmetic2.LeftEyeRenderer.material.mainTexture = cosmetic2.FaceTexture;
						this.Yandere.RPGCamera.enabled = true;
					}
					if (!this.MyAudio.isPlaying)
					{
	...
	// Token: 0x06001EFC RID: 7932 RVA: 0x001B6C00 File Offset: 0x001B4E00
	...
	// Token: 0x06001EFD RID: 7933 RVA: 0x001B6C60 File Offset: 0x001B4E60
	...
	// Token: 0x06001EFE RID: 7934 RVA: 0x001B6DC8 File Offset: 0x001B4FC8
