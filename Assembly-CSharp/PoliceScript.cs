...
{
	// Token: 0x06001AB7 RID: 6839 RVA: 0x00121C68 File Offset: 0x0011FE68
	private void Start()
	{
	...
	// Token: 0x06001AB8 RID: 6840 RVA: 0x00121E10 File Offset: 0x00120010
	private void Update()
	{
		if (this.Show)
		{
	...
	// Token: 0x06001AB9 RID: 6841 RVA: 0x00122CB4 File Offset: 0x00120EB4
	private void DetermineResults()
	{
		...
		if (!this.Suicide && !this.PoisonScene)
		{
			...
			if (this.Suspended)
			{
				...
				if (this.EndOfDay.Counselor.CounselorPunishments > 4)
				{
	...
	// Token: 0x06001ABA RID: 6842 RVA: 0x00123E04 File Offset: 0x00122004
	public void KillStudents()
	{
		...
		if (this.Deaths > 0)
		{
			...
			Debug.Log("Subtracting " + this.Corpses.ToString() + "0% school atmosphere because someone's corpse was discovered.");
	...
	// Token: 0x06001ABB RID: 6843 RVA: 0x00124280 File Offset: 0x00122480
	...
	// Token: 0x06001ABC RID: 6844 RVA: 0x001242E8 File Offset: 0x001224E8
