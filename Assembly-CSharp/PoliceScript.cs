			...
			if (!Suicide && !PoisonScene)
			{
				...
				else
				{
					...
					if (Corpses == 0 && num == 0 && BloodParent.childCount == 0 && BloodyWeapons == 0 && BloodyClothing == 0 && !SuicideScene)
					{
						...
						else if ((!StudentManager.Eighties && StudentManager.Students[2] != null && StudentManager.Students[2].Alive && Yandere.Inventory.Ring) || (StudentManager.Eighties && StudentManager.Students[30] != null && StudentManager.Students[30].Alive && Yandere.Inventory.Ring) || (Yandere.Inventory.RivalPhone && StudentManager.CommunalLocker.RivalPhone.StudentID == StudentManager.RivalID && !StudentManager.RivalEliminated) || (Yandere.Inventory.RivalPhone && StudentManager.CommunalLocker.RivalPhone.StudentID != StudentManager.RivalID && StudentManager.Students[StudentManager.CommunalLocker.RivalPhone.StudentID].Alive))
						{
