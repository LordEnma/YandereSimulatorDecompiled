...
public class ReputationSetterScript : MonoBehaviour
{
  ...
  public void InitializeReputations()
  {
    ...
    {
      StudentGlobals.SetReputationTriangle(1, new Vector3(0.0f, 0.0f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(4, new Vector3(0.0f, 10f, 0.0f));
      StudentGlobals.SetReputationTriangle(5, new Vector3(-50f, -30f, 10f));
      StudentGlobals.SetReputationTriangle(6, new Vector3(30f, 0.0f, 0.0f));
      StudentGlobals.SetReputationTriangle(7, new Vector3(-10f, -10f, -10f));
      StudentGlobals.SetReputationTriangle(8, new Vector3(0.0f, 10f, -30f));
      StudentGlobals.SetReputationTriangle(9, new Vector3(0.0f, 0.0f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(14, new Vector3(0.0f, 100f, -10f));
      StudentGlobals.SetReputationTriangle(15, new Vector3(100f, 100f, 0.0f));
      StudentGlobals.SetReputationTriangle(16, new Vector3(0.0f, -10f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(19, new Vector3(10f, 0.0f, 0.0f));
      StudentGlobals.SetReputationTriangle(20, new Vector3(100f, 100f, 100f));
      StudentGlobals.SetReputationTriangle(21, new Vector3(50f, 100f, 0.0f));
      StudentGlobals.SetReputationTriangle(22, new Vector3(30f, 50f, 0.0f));
      StudentGlobals.SetReputationTriangle(23, new Vector3(50f, 50f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(26, new Vector3(-10f, 100f, 0.0f));
      StudentGlobals.SetReputationTriangle(27, new Vector3(0.0f, 70f, 0.0f));
      StudentGlobals.SetReputationTriangle(28, new Vector3(0.0f, 50f, 0.0f));
      StudentGlobals.SetReputationTriangle(29, new Vector3(-10f, 50f, 0.0f));
      StudentGlobals.SetReputationTriangle(30, new Vector3(30f, 50f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(36, new Vector3(-70f, 100f, 0.0f));
      StudentGlobals.SetReputationTriangle(37, new Vector3(0.0f, -10f, 0.0f));
      StudentGlobals.SetReputationTriangle(38, new Vector3(50f, 0.0f, 0.0f));
      StudentGlobals.SetReputationTriangle(39, new Vector3(-50f, -10f, 0.0f));
      StudentGlobals.SetReputationTriangle(40, new Vector3(70f, -30f, 10f));
      StudentGlobals.SetReputationTriangle(41, new Vector3(0.0f, 100f, 0.0f));
      StudentGlobals.SetReputationTriangle(42, new Vector3(-50f, -30f, 30f));
      StudentGlobals.SetReputationTriangle(43, new Vector3(-10f, -10f, 0.0f));
      StudentGlobals.SetReputationTriangle(44, new Vector3(-10f, 0.0f, 0.0f));
      StudentGlobals.SetReputationTriangle(45, new Vector3(0.0f, -10f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(51, new Vector3(10f, 100f, 0.0f));
      StudentGlobals.SetReputationTriangle(52, new Vector3(30f, 70f, 0.0f));
      StudentGlobals.SetReputationTriangle(53, new Vector3(50f, 10f, 0.0f));
      StudentGlobals.SetReputationTriangle(54, new Vector3(50f, 50f, -10f));
      StudentGlobals.SetReputationTriangle(55, new Vector3(30f, 30f, 0.0f));
      StudentGlobals.SetReputationTriangle(56, new Vector3(70f, 100f, 0.0f));
      StudentGlobals.SetReputationTriangle(57, new Vector3(70f, -30f, 0.0f));
      StudentGlobals.SetReputationTriangle(58, new Vector3(70f, -30f, 0.0f));
      StudentGlobals.SetReputationTriangle(59, new Vector3(50f, -10f, 0.0f));
      StudentGlobals.SetReputationTriangle(60, new Vector3(-10f, -50f, 0.0f));
      StudentGlobals.SetReputationTriangle(61, new Vector3(-50f, 100f, 100f));
      StudentGlobals.SetReputationTriangle(62, new Vector3(0.0f, 70f, 10f));
      StudentGlobals.SetReputationTriangle(63, new Vector3(0.0f, 30f, 50f));
      ...
      StudentGlobals.SetReputationTriangle(67, new Vector3(30f, 70f, 0.0f));
      StudentGlobals.SetReputationTriangle(68, new Vector3(0.0f, 0.0f, 50f));
      StudentGlobals.SetReputationTriangle(69, new Vector3(30f, 50f, 0.0f));
      StudentGlobals.SetReputationTriangle(70, new Vector3(50f, 30f, 0.0f));
      StudentGlobals.SetReputationTriangle(71, new Vector3(100f, 100f, -100f));
      StudentGlobals.SetReputationTriangle(72, new Vector3(50f, 30f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(75, new Vector3(10f, 50f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(91, new Vector3(0.0f, 50f, 100f));
      StudentGlobals.SetReputationTriangle(92, new Vector3(0.0f, 70f, 50f));
      StudentGlobals.SetReputationTriangle(93, new Vector3(0.0f, 100f, 50f));
      StudentGlobals.SetReputationTriangle(94, new Vector3(0.0f, 70f, 100f));
      StudentGlobals.SetReputationTriangle(95, new Vector3(0.0f, 50f, 70f));
      StudentGlobals.SetReputationTriangle(96, new Vector3(0.0f, 100f, 50f));
      StudentGlobals.SetReputationTriangle(97, new Vector3(50f, 100f, 30f));
      StudentGlobals.SetReputationTriangle(98, new Vector3(0.0f, 100f, 100f));
    ...
    {
      StudentGlobals.SetReputationTriangle(1, new Vector3(100f, 100f, 0.0f));
      StudentGlobals.SetReputationTriangle(2, new Vector3(-20f, 10f, 60f));
      StudentGlobals.SetReputationTriangle(3, new Vector3(80f, 0.0f, -20f));
      StudentGlobals.SetReputationTriangle(4, new Vector3(100f, 20f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(9, new Vector3(20f, 50f, 0.0f));
      StudentGlobals.SetReputationTriangle(10, new Vector3(50f, 75f, -20f));
      StudentGlobals.SetReputationTriangle(11, new Vector3(30f, 0.0f, 0.0f));
      StudentGlobals.SetReputationTriangle(12, new Vector3(30f, 0.0f, 30f));
      StudentGlobals.SetReputationTriangle(13, new Vector3(0.0f, 45f, 45f));
      StudentGlobals.SetReputationTriangle(14, new Vector3(60f, 60f, 0.0f));
      StudentGlobals.SetReputationTriangle(15, new Vector3(0.0f, 75f, 75f));
      StudentGlobals.SetReputationTriangle(16, new Vector3(90f, 90f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(20, new Vector3(100f, 100f, 100f));
      StudentGlobals.SetReputationTriangle(21, new Vector3(45f, 20f, 0.0f));
      StudentGlobals.SetReputationTriangle(22, new Vector3(40f, 20f, 0.0f));
      StudentGlobals.SetReputationTriangle(23, new Vector3(60f, -20f, -10f));
      StudentGlobals.SetReputationTriangle(24, new Vector3(75f, 30f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(40, new Vector3(40f, 55f, 0.0f));
      StudentGlobals.SetReputationTriangle(41, new Vector3(40f, 85f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(44, new Vector3(15f, 0.0f, -10f));
      StudentGlobals.SetReputationTriangle(45, new Vector3(50f, 30f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(48, new Vector3(-50f, 0.0f, 75f));
      ...
      StudentGlobals.SetReputationTriangle(52, new Vector3(30f, 55f, 0.0f));
      StudentGlobals.SetReputationTriangle(53, new Vector3(45f, 10f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(56, new Vector3(30f, 25f, 0.0f));
      StudentGlobals.SetReputationTriangle(57, new Vector3(20f, 70f, -10f));
      StudentGlobals.SetReputationTriangle(58, new Vector3(-5f, -10f, 0.0f));
      StudentGlobals.SetReputationTriangle(59, new Vector3(15f, -10f, 0.0f));
      StudentGlobals.SetReputationTriangle(60, new Vector3(20f, 15f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(65, new Vector3(15f, 30f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(68, new Vector3(30f, 20f, 0.0f));
      ...
      StudentGlobals.SetReputationTriangle(71, new Vector3(45f, 85f, 0.0f));
