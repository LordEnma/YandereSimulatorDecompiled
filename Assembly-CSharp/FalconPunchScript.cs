...
{
	// Token: 0x0600147C RID: 5244 RVA: 0x000C7EF3 File Offset: 0x000C60F3
	private void Start()
	{
		if (this.Mecha)
		{
	...
	// Token: 0x0600147D RID: 5245 RVA: 0x000C7F28 File Offset: 0x000C6128
	private void Update()
	{
		if (!this.IgnoreTime)
		{
	...
	// Token: 0x0600147E RID: 5246 RVA: 0x000C7F94 File Offset: 0x000C6194
