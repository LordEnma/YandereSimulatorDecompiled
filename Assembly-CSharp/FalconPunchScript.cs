...
{
	// Token: 0x06001481 RID: 5249 RVA: 0x000C84AB File Offset: 0x000C66AB
	private void Start()
	{
		if (this.Mecha)
		{
	...
	// Token: 0x06001482 RID: 5250 RVA: 0x000C84E0 File Offset: 0x000C66E0
	private void Update()
	{
		if (!this.IgnoreTime)
		{
	...
	// Token: 0x06001483 RID: 5251 RVA: 0x000C854C File Offset: 0x000C674C
