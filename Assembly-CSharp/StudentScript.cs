...
public class StudentScript : MonoBehaviour
{
  ...
  public void Start()
  {
    ...
    if (!this.Started)
    {
      ...
      if (!this.StudentManager.Eighties)
      {
        ...
        else if (this.StudentID == 10)
        {
          ...
          if ((UnityEngine.Object) this.StudentManager.Students[11] != (UnityEngine.Object) null && DatingGlobals.SuitorProgress < 2 && (double) StudentGlobals.GetStudentReputation(10) > -33.3333282470703 && StudentGlobals.StudentSlave != 11 && !GameGlobals.AlphabetMode && !this.StudentManager.MissionMode)
          {
          ...
          {
            Debug.Log((object) "Due to the circumstances, we're changing Raibaru's destinations.");
        ...
        else if (this.StudentID == 34 || this.StudentID == 35)
        {
          this.IdleAnim = "f02_idleShort_00";
          this.WalkAnim = "f02_newWalk_00";
          if ((double) this.Paranoia > 1.66665995121002)
          {
            this.IdleAnim = this.ParanoidAnim;
        ...
        else if (this.StudentID == 36)
        {
          ...
          {
            Debug.Log((object) "Changing Gema's routine for Mission Mode.");
        ...
        else if (this.StudentID == 51)
        {
          ...
          if (this.StudentManager.MissionMode)
          {
            Debug.Log((object) "Changing Miyuji's routine for Mission Mode.");
            ScheduleBlock scheduleBlock = this.ScheduleBlocks[4];
            scheduleBlock.destination = "LunchSpot";
            scheduleBlock.action = "Eat";
          }
      ...
      if (this.Persona == PersonaType.Sleuth)
      {
        if ((double) SchoolGlobals.SchoolAtmosphere <= 0.800000011920929 || this.Grudge)
          this.BecomeSleuth();
        else if ((double) SchoolGlobals.SchoolAtmosphere <= 0.899999976158142)
        {
          this.WalkAnim = this.ParanoidWalkAnim;
          this.CameraAnims = this.HeroAnims;
        }
    ...
    Array.Copy((Array) this.ScheduleBlocks, (Array) this.OriginalScheduleBlocks, this.ScheduleBlocks.Length);
    ...
    if (this.Routine)
    {
      ...
      else if (this.Phase < this.ScheduleBlocks.Length - 1 && (double) this.Clock.HourTime >= (double) this.ScheduleBlocks[this.Phase].time && !this.InEvent && !this.Meeting && this.ClubActivityPhase < 16 && !this.Ragdoll.Zs.activeInHierarchy)
      {
        ...
        if (this.Club == ClubType.Gardening && this.StudentID != 71 && this.Actions[this.Phase] == StudentActionType.ClubAction)
        {
          if (!this.StudentManager.Eighties)
          {
            if ((UnityEngine.Object) this.WateringCan.transform.parent != (UnityEngine.Object) this.Hips)
            {
      ...
      if ((double) this.MeetTime > 0.0 && !this.InEvent && (double) this.Clock.HourTime > (double) this.MeetTime)
      {
...
label_185:
        ...
        if (this.Actions[this.Phase] != StudentActionType.Follow || this.Actions[this.Phase] == StudentActionType.Follow && (double) this.DistanceToDestination > (double) this.TargetDistance + 0.100000001490116)
        {
          if (this.Actions[this.Phase] == StudentActionType.Follow && (this.Clock.Period == 1 && (double) this.Clock.HourTime > 8.48333358764648 || this.Clock.Period == 3 && (double) this.Clock.HourTime > 13.4833335876465))
            this.Pathfinding.speed = 4f;
          ...
          if (!this.Pathfinding.canMove)
          {
            if (!this.Spawned)
            {
              ...
              this.Spawned = true;
              if (this.StudentID == 10 && (UnityEngine.Object) this.StudentManager.Students[11] == (UnityEngine.Object) null && !this.StudentManager.Eighties)
              {
                Debug.Log((object) "Raibaru runs this code.");
          ...
          if (!this.Meeting && !this.GoAway && !this.InEvent)
          {
            ...
            if (this.Actions[this.Phase] == StudentActionType.Patrol && (UnityEngine.Object) this.CurrentDestination != (UnityEngine.Object) this.StudentManager.Patrols.List[this.StudentID].GetChild(this.PatrolID))
            {
              this.CurrentDestination = this.StudentManager.Patrols.List[this.StudentID].GetChild(this.PatrolID);
              this.Pathfinding.target = this.CurrentDestination;
            }
        ...
        if (this.CuriosityPhase == 1 && this.CurrentAction == StudentActionType.Relax)
        {
          ...
          {
            Debug.Log((object) "This code is called when a student is stalking their crush and their crush is in the shower room.");
            this.Pathfinding.target = this.Destinations[this.Phase];
            this.CurrentDestination = this.Destinations[this.Phase];
            this.TargetDistance = 0.5f;
            this.CuriosityTimer = 0.0f;
        ...
        if (!this.Meeting)
        {
          if (!this.GoAway)
          {
            ...
            else if (this.Actions[this.Phase] == StudentActionType.Socializing || this.Actions[this.Phase] == StudentActionType.Follow && (UnityEngine.Object) this.FollowTarget != (UnityEngine.Object) null && this.FollowTarget.Actions[this.Phase] != StudentActionType.Clean && (double) this.FollowTargetDistance < 1.0 && !this.FollowTarget.Alone && !this.FollowTarget.InEvent && !this.FollowTarget.Talking && !this.FollowTarget.Meeting && !this.FollowTarget.Confessing && (double) this.FollowTarget.DistanceToDestination < 1.0)
            {
              ...
              if ((double) this.Paranoia > 1.66665995121002 && !this.StudentManager.LoveSick && this.Club != ClubType.Delinquent)
              {
                this.CharacterAnimation.CrossFade(this.IdleAnim);
              }
              else
            ...
            else if (this.Actions[this.Phase] == StudentActionType.Gossip)
            {
              if (this.StudentID == 82 && this.Clock.Day == 5)
                this.BountyCollider.SetActive(true);
              if ((double) this.Paranoia > 1.66665995121002 && !this.StudentManager.LoveSick)
              {
                this.CharacterAnimation.CrossFade(this.IdleAnim);
              }
              else
            ...
            {
              if ((UnityEngine.Object) this.Follower != (UnityEngine.Object) null && this.Follower.Actions[this.Phase] != StudentActionType.SitAndTakeNotes && (double) this.Clock.HourTime < 15.5)
            ...
            else if (this.Actions[this.Phase] == StudentActionType.ClubAction)
            {
              ...
              else if (this.Club == ClubType.Sports)
              {
                ...
                else
                {
                  ...
                  if ((double) this.CharacterAnimation[this.ClubAnim].time >= 0.100000001490116)
                    this.SetSplashes(false);
                  if (!this.StudentManager.Eighties && (double) this.CharacterAnimation[this.ClubAnim].time >= 4.66665983200073)
                  {
                    float num = this.Cosmetic.Goggles[this.StudentID].GetComponent<SkinnedMeshRenderer>().GetBlendShapeWeight(0) - Time.deltaTime * 200f;
                    this.Cosmetic.Goggles[this.StudentID].GetComponent<SkinnedMeshRenderer>().SetBlendShapeWeight(0, num);
                  }
            ...
            else if (this.Actions[this.Phase] == StudentActionType.Patrol)
            {
              ...
              if (this.StudentID == 1)
              {
                ...
                this.CharacterAnimation.CrossFade(this.PatrolAnim);
              if ((double) this.PatrolTimer >= (double) this.CharacterAnimation[this.PatrolAnim].length)
              {
                ++this.PatrolID;
                if (this.PatrolID == this.StudentManager.Patrols.List[this.StudentID].childCount)
                  this.PatrolID = 0;
            ...
            else if (this.Actions[this.Phase] == StudentActionType.Texting)
            {
              ...
              if ((double) this.SmartPhone.transform.localPosition.x != 0.0199999995529652)
              {
              ...
              if ((UnityEngine.Object) this.StudentManager.Students[this.StudentManager.VictimID] != (UnityEngine.Object) null)
              {
                ...
                else
                {
                  ...
                  if (this.BullyID == 1)
                  {
                    ...
                    {
                      if ((double) this.CharacterAnimation["f02_bullyEraser_00"].time < 0.833333015441895)
                        return;
                      this.BullyDust.Play();
                      ++this.BullyPhase;
                    }
            ...
            else if (this.Actions[this.Phase] == StudentActionType.Sulk)
            {
              if (this.StudentID == 51)
              {
                ...
                if ((double) this.SulkTimer <= 7.66665983200073)
                  return;
                this.SulkTimer = 0.0f;
                ++this.SulkPhase;
                if (this.SulkPhase != 3)
            ...
            {
              if (this.Actions[this.Phase] != StudentActionType.Guard)
                return;
              this.CharacterAnimation.CrossFade(this.IdleAnim);
            }
          }
    ...
    else
    {
            ...
            else
            {
              ...
              else if (this.Persona == PersonaType.Heroic)
              {
                ...
                else if (!this.Yandere.Attacking && !this.StudentManager.PinningDown && !this.Yandere.Shoved)
                {
                  if (this.StudentID > 1)
                  {
                    if (!this.Yandere.Struggling && (double) this.Yandere.ShoulderCamera.Timer == 0.0)
                      this.BeginStruggle();
                  ...
                  else if ((UnityEngine.Object) this.Yandere.Mask != (UnityEngine.Object) null)
                  {
                    ...
                    if ((double) this.CharacterAnimation["unmasking_00"].time >= 0.666660010814667 && (UnityEngine.Object) this.Yandere.Mask.transform.parent != (UnityEngine.Object) this.LeftHand)
                    {
                ...
                if (!this.WitnessedMurder)
                {
                  ...
                  else if (this.ReportPhase != 6)
                  {
                    ...
                    else if (this.ReportPhase == 8)
                    {
                      ...
                      if ((double) this.CharacterAnimation["f02_teacherPickUp_00"].time >= 0.333330005407333)
        ...
        if ((double) this.DistanceToDestination < (double) this.TargetDistance)
        {
          if (!this.Splashed)
          {
            ...
            else if (this.BathePhase == 0)
            {
              this.transform.rotation = Quaternion.Slerp(this.transform.rotation, this.CurrentDestination.rotation, Time.deltaTime * 10f);
              this.MoveTowardsTarget(this.CurrentDestination.position);
              if ((double) this.CharacterAnimation["f02_electrocution_00"].time > 2.0 && (double) this.CharacterAnimation["f02_electrocution_00"].time < 5.95000028610229)
              {
                ...
                else
                {
                  ...
                  if ((double) this.ElectroTimer > 0.100000001490116)
                  {
              ...
              else if ((double) this.CharacterAnimation["f02_electrocution_00"].time > 5.95000028610229 && (double) this.CharacterAnimation["f02_electrocution_00"].time < (double) this.CharacterAnimation["f02_electrocution_00"].length)
              {
                if (this.LightSwitch.Flicker)
                {
          ...
          if (this.HuntTarget.Alive && !this.HuntTarget.Tranquil && !this.HuntTarget.PinningDown)
          {
            ...
            else if (!this.NEStairs.bounds.Contains(this.transform.position) && !this.NWStairs.bounds.Contains(this.transform.position) && !this.SEStairs.bounds.Contains(this.transform.position) && !this.SWStairs.bounds.Contains(this.transform.position) && !this.NEStairs.bounds.Contains(this.HuntTarget.transform.position) && !this.NWStairs.bounds.Contains(this.HuntTarget.transform.position) && !this.SEStairs.bounds.Contains(this.HuntTarget.transform.position) && !this.SWStairs.bounds.Contains(this.HuntTarget.transform.position))
            {
              ...
              else
              {
                ...
                {
                  if ((double) this.CharacterAnimation["f02_murderSuicide_00"].time >= 2.40000009536743)
                  {
                    this.MyWeapon.transform.parent = this.ItemParent;
                    this.MyWeapon.transform.localScale = new Vector3(1f, 1f, 1f);
                    this.MyWeapon.transform.localPosition = Vector3.zero;
                ...
                {
                  if ((double) this.CharacterAnimation["f02_murderSuicide_00"].time >= 3.29999995231628)
                  {
                ...
                else if (this.MurderSuicidePhase == 3)
                {
                  if (!this.KnifeDown)
                  {
                    if ((double) this.MyWeapon.transform.position.y < (double) this.transform.position.y + 0.333333343267441)
                    {
                      UnityEngine.Object.Instantiate<GameObject>(this.BloodEffect, this.MyWeapon.transform.position, Quaternion.identity);
                      this.KnifeDown = true;
                  ...
                  else if ((double) this.MyWeapon.transform.position.y > (double) this.transform.position.y + 0.333333343267441)
                    this.KnifeDown = false;
                  if ((double) this.CharacterAnimation["f02_murderSuicide_00"].time >= 16.6666660308838)
                  {
                ...
                {
                  if ((double) this.CharacterAnimation["f02_murderSuicide_00"].time >= 18.8999996185303)
                  {
                ...
                {
                  if ((double) this.CharacterAnimation["f02_murderSuicide_00"].time >= 26.1666660308838)
                  {
      ...
      if (this.Suicide)
      {
        ...
        else if (this.MurderSuicidePhase == 1)
        {
          ...
          if ((double) this.CharacterAnimation["f02_suicide_00"].time >= 0.733333349227905)
          {
            this.MyWeapon.transform.parent = this.ItemParent;
            this.MyWeapon.transform.localScale = new Vector3(1f, 1f, 1f);
            this.MyWeapon.transform.localPosition = Vector3.zero;
        ...
        {
          if ((double) this.CharacterAnimation["f02_suicide_00"].time >= 4.16666650772095)
          {
            Debug.Log((object) "Stabbed neck!");
        ...
        {
          if ((double) this.CharacterAnimation["f02_suicide_00"].time >= 6.16666650772095)
          {
            Debug.Log((object) "BLOOD FOUNTAIN!");
      ...
      if (this.Investigating)
      {
        ...
        else if (this.InvestigationPhase == 100)
        {
          ...
          {
            Debug.Log((object) "This character was in InvestigationPhase 100.");
            this.StopInvestigating();
          }
        }
      }
      if (this.EndSearch)
      {
        ...
        if ((double) this.PatrolTimer > 5.0)
        {
          ...
          this.GetDestinations();
          Array.Copy((Array) this.OriginalActions, (Array) this.Actions, this.OriginalActions.Length);
          this.CurrentDestination = this.Destinations[this.Phase];
          this.Pathfinding.target = this.Destinations[this.Phase];
          this.CurrentAction = this.Actions[this.Phase];
          this.DistanceToDestination = 100f;
          Debug.Log((object) (this.Name + " has just reacquired their phone."));
      ...
      if (this.Shoving)
      {
        ...
        if ((double) this.CharacterAnimation[this.ShoveAnim].time > (double) this.CharacterAnimation[this.ShoveAnim].length)
        {
          ...
          if (this.Patience > 0)
          {
            Debug.Log((object) "We just finished shoving.");
            this.Pathfinding.canSearch = true;
            this.Pathfinding.canMove = true;
            this.Distracted = false;
            this.Shoving = false;
      ...
      if (this.SentHome)
      {
        ...
        {
          if ((double) this.CharacterAnimation[this.SentHomeAnim].time > 0.666660010814667)
          {
            this.SmartPhone.SetActive(true);
            ++this.SentHomePhase;
          }
      ...
      if (this.DramaticReaction)
      {
        ...
        else if (this.DramaticPhase == 1)
        {
          ...
          this.DramaticTimer += Time.deltaTime;
          if ((double) this.DramaticCamera.rect.height < 0.00999999977648258 || (double) this.DramaticTimer > 0.5)
          {
      ...
      if (this.Dodging)
      {
        ...
        else if ((double) this.CharacterAnimation[this.DodgeAnim].time < 0.666660010814667)
        {
      ...
      if (this.ReturningMisplacedWeapon)
      {
        if (this.ReturningMisplacedWeaponPhase == 0)
        {
          ...
          if ((this.Club == ClubType.Council || this.Teacher) && (double) this.CharacterAnimation[this.PickUpAnim].time >= 0.333330005407333)
            this.Handkerchief.SetActive(true);
        ...
        {
          this.CharacterAnimation.CrossFade(this.WalkAnim);
          if ((double) this.DistanceToDestination < 1.10000002384186)
      ...
      if (this.GoAway)
      {
        Debug.Log((object) "Uh, is this happening?");
        this.GoAwayTimer += Time.deltaTime;
    ...
    for (this.ID = 0; this.ID < this.Police.Corpses; ++this.ID)
    {
      ...
      if ((UnityEngine.Object) corpse != (UnityEngine.Object) null && !corpse.Hidden && !corpse.Concealed)
      {
        ...
        if ((double) allCollider.transform.position.y < (double) this.transform.position.y + 4.0)
          flag = true;
        if (flag && this.CanSeeObject(allCollider.gameObject, allCollider.transform.position, this.CorpseLayers, (int) this.Mask))
        {
      ...
      if (((this.WitnessedMurder || this.CheckingNote || this.Shoving || this.Slave ? 0 : (!this.Struggling ? 1 : 0)) & (flag2 ? 1 : 0)) != 0 && !this.Drownable && !this.Fighting)
      {
        if (this.Police.Corpses > 0)
        {
          ...
          if (this.VisibleCorpses.Count > 0)
          {
            if (!this.WitnessedCorpse)
            {
              Debug.Log((object) (this.Name + " discovered a corpse."));
          ...
          if (!this.Talking && !this.Spraying && !this.SentHome && !this.Slave)
          {
            if (!this.Yandere.Noticed && !this.Yandere.Invisible)
            {
              ...
              if (this.Guarding || this.Fleeing || this.InvestigatingBloodPool)
                flag3 = true;
              if (this.Yandere.Armed && this.Yandere.EquippedWeapon.Suspicious || this.Yandere.Armed && this.Yandere.EquippedWeapon.Bloody || this.StudentID > 1 && (UnityEngine.Object) this.Yandere.PickUp != (UnityEngine.Object) null && this.Yandere.PickUp.Suspicious || this.StudentID > 1 && (UnityEngine.Object) this.Yandere.PickUp != (UnityEngine.Object) null && this.Yandere.PickUp.CleaningProduct && this.Clock.Period != 5 || (double) this.Yandere.Bloodiness + (double) this.Yandere.GloveBlood > 0.0 && !this.Yandere.Paint || (double) this.Yandere.Sanity < 33.3330001831055 || this.Yandere.Pickpocketing || this.Yandere.Attacking || this.Yandere.Cauterizing || this.Yandere.Struggling || this.Yandere.Dragging && !this.Yandere.CurrentRagdoll.Concealed || this.Yandere.Dragging && this.Yandere.CurrentRagdoll.Concealed && this.Clock.Period != 5 || !this.IgnoringPettyActions && this.Yandere.Lewd || this.Yandere.Carrying && !this.Yandere.CurrentRagdoll.Concealed || this.Yandere.Carrying && this.Yandere.CurrentRagdoll.Concealed && this.Clock.Period != 5 || this.Yandere.Medusa || this.Yandere.Poisoning || this.Yandere.Pickpocketing || (double) this.Yandere.WeaponTimer > 0.0 || this.Yandere.WearingRaincoat || (double) this.Yandere.MurderousActionTimer > 0.0 || !this.IgnoringPettyActions && this.Yandere.Schoolwear == 2 && (double) this.Yandere.transform.position.z < 30.0 || (UnityEngine.Object) this.Yandere.PickUp != (UnityEngine.Object) null && (UnityEngine.Object) this.Yandere.PickUp.BodyPart != (UnityEngine.Object) null && !this.Yandere.PickUp.Garbage || !this.IgnoringPettyActions && (double) this.Yandere.SuspiciousActionTimer > 0.0 || !this.IgnoringPettyActions && this.Yandere.Laughing && (double) this.Yandere.LaughIntensity > 15.0 || !this.IgnoringPettyActions && this.Yandere.Stance.Current == StanceType.Crouching || !this.IgnoringPettyActions && this.Yandere.Stance.Current == StanceType.Crawling || this.Yandere.Trespassing || this.Private && this.Yandere.Eavesdropping || this.Teacher && !this.WitnessedCorpse && this.Yandere.Trespassing || this.Teacher && !this.IgnoringPettyActions && this.Yandere.Rummaging || !this.IgnoringPettyActions && (double) this.Yandere.TheftTimer > 0.0 || this.StudentID == 1 && this.Yandere.NearSenpai && !this.Yandere.Talking || this.Yandere.Eavesdropping && this.Private || !this.IgnoringPettyActions && !this.StudentManager.CombatMinigame.Practice && this.Yandere.DelinquentFighting && this.StudentID != 10 && this.StudentManager.CombatMinigame.Path < 4 && !this.StudentManager.CombatMinigame.Practice && !this.Yandere.SeenByAuthority || flag3 && (UnityEngine.Object) this.Yandere.PickUp != (UnityEngine.Object) null && (UnityEngine.Object) this.Yandere.PickUp.Mop != (UnityEngine.Object) null && (double) this.Yandere.PickUp.Mop.Bloodiness > 0.0 || flag3 && (UnityEngine.Object) this.Yandere.PickUp != (UnityEngine.Object) null && (UnityEngine.Object) this.Yandere.PickUp.BodyPart != (UnityEngine.Object) null && !this.Yandere.PickUp.Garbage || (UnityEngine.Object) this.Yandere.PickUp != (UnityEngine.Object) null && this.Yandere.PickUp.Clothing && this.Yandere.PickUp.Evidence)
              {
                bool flag4 = false;
                  ...
                  else if (!this.Fleeing && (!this.Alarmed || this.CanStillNotice))
                  {
                    ...
                    if ((double) this.IgnoreTimer == 0.0 || this.CanStillNotice)
                    {
                      ...
                      if (!this.Yandere.Chased && this.Yandere.Chasers == 0)
                      {
                        ...
                        if ((double) this.Yandere.SuspiciousActionTimer > 0.0)
  ...
  {
    Debug.Log((object) (this.Name + " just called the BecomeAlarmed() function."));
    ...
    else
    {
      ...
      {
        Debug.Log((object) (this.Name + " has become alarmed by something."));
        bool flag = false;
        ...
        if (this.YandereVisible && !this.NotAlarmedByYandereChan)
        {
          ...
          {
            Debug.Log((object) "A teacher has just witnessed Yandere-chan doing something bad.");
            if (!this.Fleeing)
            {
              if (this.Concern < 5)
                this.CameraEffects.Alarm();
  ...
  private void UpdateTalkInput()
  {
    if ((double) this.Prompt.Circle[0].fillAmount == 0.0)
    {
      if (!this.StudentManager.EmptyDemon && ((double) this.Alarm > 0.0 || (double) this.AlarmTimer > 0.0 || this.Yandere.Armed || this.Yandere.Shoved || this.Waiting || this.InEvent || this.SentHome || this.Threatened || this.Guarding || this.Distracted && !this.Drownable || this.StudentID == 1 || this.Yandere.YandereVision) && (!this.Slave && !this.BadTime && !this.Yandere.Gazing && !this.FightingSlave || this.Yandere.YandereVision))
      {
        if (this.InEvent)
        {
          string str = "She";
      ...
      if ((double) this.Prompt.Circle[0].fillAmount == 0.0)
      {
        ...
        else if (this.Clock.Period == 2 || this.Clock.Period == 4 || this.StudentID < 90 && (UnityEngine.Object) this.CurrentDestination == (UnityEngine.Object) this.Seat)
        {
          ...
          else
          {
            ...
            if (!this.Grudge)
            {
              ...
              else
              {
                ...
                if (flag1)
                {
                  Debug.Log((object) "This character is able to discuss club leader stuff right now.");
    ...
    if ((double) this.Prompt.Circle[2].fillAmount != 0.0 && ((double) this.Yandere.Sanity >= 33.3333282470703 || !this.Yandere.CanMove || this.Prompt.HideButton[2] || !this.Prompt.InSight || this.Club == ClubType.Council || this.Struggling || this.Chasing || (double) this.DistanceToPlayer >= 1.39999997615814 || !this.SeenByYandere() || this.StudentID <= 1))
      return;
    ...
    else
    {
      ...
      if (flag10 || this.StudentManager.OriginalUniforms + this.StudentManager.NewUniforms > 1)
      {
        ...
        else if (this.Yandere.EquippedWeapon.WeaponID != 27 || this.Yandere.EquippedWeapon.WeaponID == 27 && this.Yandere.AttackManager.Stealth)
          this.AttackReaction();
        else
      ...
      else
      {
        ...
        else if (this.StudentID > 1)
        {
          ...
          else
          {
            ...
            if (this.FocusOnYandere)
            {
              if ((double) this.DistanceToPlayer < 1.0 && !this.Injured && (this.Club == ClubType.Council || this.Club == ClubType.Delinquent && !this.Injured))
              {
                this.AlarmTimer = 0.0f;
        ...
        else if ((double) this.AlarmTimer > 1.0 && !this.Reacted)
        {
            ...
            if (!this.WitnessedCorpse)
            {
              ...
              switch (this.Witnessed)
              {
                ...
                case StudentWitnessType.Violence:
                  Debug.Log((object) "A teacher witnessed violence.");
              ...
              if ((UnityEngine.Object) this.BloodPool != (UnityEngine.Object) null)
              {
                Debug.Log((object) ("The teacher was alarmed because she saw something weird on the ground - a " + this.BloodPool.name));
                UnityEngine.Object.Destroy((UnityEngine.Object) this.Subtitle.CurrentClip);
                this.Subtitle.UpdateLabel(SubtitleType.BloodPoolReaction, 2, 5f);
                PromptScript component = this.BloodPool.GetComponent<PromptScript>();
                if ((UnityEngine.Object) component != (UnityEngine.Object) null)
                {
                  Debug.Log((object) "Disabling a bloody object's prompt because a teacher is heading for it.");
                  component.Hide();
                  component.enabled = false;
                }
              }
          ...
          else if (this.StudentID > 1 || (UnityEngine.Object) this.Yandere.Mask != (UnityEngine.Object) null)
          {
            ...
            {
              Debug.Log((object) ("We are now determining what subtitle " + this.Name + " should be saying."));
        ...
        if (this.Club != ClubType.Council || (double) this.DistanceToPlayer >= 1.10000002384186 || this.Yandere.Invisible || !this.Yandere.Armed && (!this.Yandere.Carrying || this.Yandere.CurrentRagdoll.Concealed) && (!this.Yandere.Dragging || this.Yandere.CurrentRagdoll.Concealed) || !this.Prompt.InSight)
          return;
  ...
  private void UpdateBurning()
  {
    ...
    {
      if ((UnityEngine.Object) this.Yandere.PickUp != (UnityEngine.Object) null && this.Yandere.PickUp.OpenFlame)
  ...
  private void UpdateMisc()
  {
    ...
    if (!this.Fleeing)
    {
      ...
      else
      {
        ...
        if (this.Club == ClubType.Council && !this.WitnessedSomething)
        {
          if ((double) this.DistanceToPlayer < 5.0)
          {
            ...
            if ((double) Mathf.Abs(Vector3.Angle(-this.transform.forward, this.Yandere.transform.position - this.transform.position)) <= 45.0 && this.Yandere.Stance.Current != StanceType.Crouching && this.Yandere.Stance.Current != StanceType.Crawling && this.Yandere.CanMove && ((double) this.Yandere.h != 0.0 || (double) this.Yandere.v != 0.0) && (this.Yandere.Running || (double) this.DistanceToPlayer < 2.0))
            {
              if (this.Investigating)
                this.StopInvestigating();
              Debug.Log((object) (this.Name + " was alarmed because Yandere-chan was running nearby."));
          ...
          if ((double) this.DistanceToPlayer < 1.10000002384186 && !this.Yandere.Invisible && (double) Mathf.Abs(Vector3.Angle(-this.transform.forward, this.Yandere.transform.position - this.transform.position)) > 45.0 && (this.Yandere.Armed || this.Yandere.Carrying && !this.Yandere.CurrentRagdoll.Concealed || this.Yandere.Dragging && !this.Yandere.CurrentRagdoll.Concealed) && this.Prompt.InSight)
          {
            if (this.Yandere.Armed && !this.Yandere.EquippedWeapon.Suspicious && !this.WitnessedMurder)
              this.Shove();
            else
        ...
        if ((this.Club != ClubType.Council || this.Spraying) && (this.Club != ClubType.Delinquent || this.Injured || this.RespectEarned || this.Vomiting || this.Emetic || this.Headache || this.Sedated || this.Lethal) || (double) this.DistanceToPlayer >= 0.5 || !this.Yandere.CanMove || (double) this.Yandere.h == 0.0 && (double) this.Yandere.v == 0.0)
          return;
        if (this.Club == ClubType.Delinquent)
        {
          this.Subtitle.Speaker = this;
    ...
    {
      if (this.Club != ClubType.Council || (double) this.DistanceToPlayer >= 1.10000002384186 || this.Yandere.Invisible || (double) Mathf.Abs(Vector3.Angle(-this.transform.forward, this.Yandere.transform.position - this.transform.position)) <= 45.0 || !this.Yandere.Armed && (!this.Yandere.Carrying || this.Yandere.CurrentRagdoll.Concealed) && (!this.Yandere.Dragging || this.Yandere.CurrentRagdoll.Concealed) || !this.Prompt.InSight)
        return;
      if (this.Yandere.Armed && !this.Yandere.EquippedWeapon.Suspicious && !this.WitnessedMurder)
        this.Shove();
      else
  ...
  public void CalculateReputationPenalty()
  {
    ...
    if ((double) PlayerGlobals.Reputation < -33.3333282470703)
      this.RepDeduction += this.RepLoss * 0.2f;
    if ((double) PlayerGlobals.Reputation > 33.3333282470703)
      this.RepDeduction -= this.RepLoss * 0.2f;
    if (this.Friend)
  ...
  {
    if ((double) Time.timeScale <= 9.99999974737875E-05 || !this.MyController.enabled)
      return;
  ...
  public void SenpaiNoticed()
  {
    ...
    this.Yandere.Noticed = true;
    if ((UnityEngine.Object) this.WeaponToTakeAway != (UnityEngine.Object) null && this.Teacher && !this.Yandere.Attacking)
    {
      Debug.Log((object) "Taking away Yandere-chan's weapon.");
  ...
  private void WitnessMurder()
  {
    ...
    {
      Debug.Log((object) (this.Name + " is reverting back into their original Persona."));
      this.Persona = this.OriginalPersona;
  ...
  private void PersonaReaction()
  {
    ...
    else if (this.Persona == PersonaType.TeachersPet)
    {
      ...
      else
      {
        ...
        {
          Debug.Log((object) (this.Name + " is going to run and hide in their classroom."));
          this.PetDestination = UnityEngine.Object.Instantiate<GameObject>(this.EmptyGameObject, this.Seat.position + this.Seat.forward * -0.5f, Quaternion.identity).transform;
          this.Pathfinding.target = this.PetDestination;
          this.CurrentDestination = this.PetDestination;
          if (this.Distracting)
    ...
    else if (this.Persona == PersonaType.Lovestruck)
    {
      ...
      bool flag = false;
      if (!this.WitnessedMurder && (UnityEngine.Object) this.Corpse != (UnityEngine.Object) null && (this.Corpse.Student.Rival || this.Corpse.StudentID == this.StudentManager.ObstacleID))
        flag = true;
      if (flag)
      {
    ...
    else if (this.Persona == PersonaType.Violent)
    {
      ...
      {
        Debug.Log((object) "A delinquent has reached the ''Flee'' protocol.");
  ...
  public void GetDestinations()
  {
    ...
    for (this.ID = 1; this.ID < this.JSON.Students[this.StudentID].ScheduleBlocks.Length; ++this.ID)
    {
      ...
      else if (scheduleBlock.destination == "Patrol")
      {
        ...
        {
          Debug.Log((object) "This student's club disbanded, so their destination has been set to ''Hangout''.");
          this.Destinations[this.ID] = this.StudentManager.Hangouts.List[this.StudentID];
        }
      }
  ...
  {
    Debug.Log((object) ("Turning " + this.Name + "'s outlines orange."));
    for (this.ID = 0; this.ID < this.Outlines.Length; ++this.ID)
    {
      if ((UnityEngine.Object) this.Outlines[this.ID] != (UnityEngine.Object) null)
      {
  ...
  {
    Debug.Log((object) "ChangeSchoolwear() is being called.");
    for (this.ID = 0; this.ID < this.CensorSteam.Length; ++this.ID)
    ...
    else if (this.Schoolwear == 3)
    {
      ...
      if (this.StudentManager.Eighties)
      {
        ...
        Debug.Log((object) "Setting the GymTexture to the EightiesGymTexture.");
      }
      else
        Debug.Log((object) "Not setting the GymTexture to the EightiesGymTexture.");
      if (!this.Male)
      {
  ...
  private bool LovedOneIsTargeted(int yandereTargetID)
  {
    ...
    if (!this.StudentManager.Eighties)
    {
      ...
      int num2 = flag2 ? 1 : 0;
      return (num1 | num2 | (flag3 ? 1 : 0) | (flag4 ? 1 : 0) | (flag5 ? 1 : 0) | (flag6 ? 1 : 0) | (flag7 ? 1 : 0) | (flag8 ? 1 : 0) | (flag9 ? 1 : 0) | (flag10 ? 1 : 0) | (flag1 ? 1 : 0)) != 0;
    }
  ...
  public void AltTeleportToDestination()
  {
    ...
    {
      if (!((UnityEngine.Object) this.Destinations[this.Phase] != (UnityEngine.Object) null))
        return;
      this.CurrentDestination = this.Destinations[this.Phase];
      this.Pathfinding.target = this.Destinations[this.Phase];
      this.transform.position = this.CurrentDestination.position;
  ...
  {
    Debug.Log((object) (this.Name + " has stopped being alarmed."));
  ...
  private void PhoneAddictCameraUpdate()
  {
    ...
    if (!this.StudentManager.Eighties)
    {
      ...
      this.SmartPhone.transform.localEulerAngles = new Vector3(7.33333f, -154f, 173.6667f);
    }
    else
    {
  ...
  public void UpdateAnimLayers()
  {
    ...
    if (this.Club == ClubType.Bully)
    {
      if (!StudentGlobals.GetStudentBroken(this.StudentID) && this.BullyID > 1)
        this.CharacterAnimation["f02_bullyLaugh_00"].speed = (float) (0.899999976158142 + (double) this.BullyID * 0.100000001490116);
    }
    else if (this.Club == ClubType.Delinquent)
    {
      this.CharacterAnimation[this.WalkAnim].time = UnityEngine.Random.Range(0.0f, this.CharacterAnimation[this.WalkAnim].length);
  ...
  public void DetermineWhatWasWitnessed()
  {
    ...
    else if (this.YandereVisible)
    {
      ...
      if (flag2)
        ...
        Debug.Log((object) (this.Name + " did not see the player carrying a suspicious weapon."));
      if (this.Yandere.Rummaging || (double) this.Yandere.TheftTimer > 0.0)
      {
      ...
      else if (flag2 & flag1 && (double) this.Yandere.Sanity < 33.3330001831055)
      {
      ...
      else if (flag2 && (double) this.Yandere.Sanity < 33.3330001831055)
      {
      ...
      else if (flag1 && (double) this.Yandere.Sanity < 33.3330001831055)
      {
      ...
      else if (this.Yandere.Laughing && (double) this.Yandere.LaughIntensity > 15.0 || this.StudentID > 1 && this.Yandere.Stance.Current == StanceType.Crouching || this.Yandere.Stance.Current == StanceType.Crawling || (double) this.Yandere.SuspiciousActionTimer > 0.0 || this.Yandere.WearingRaincoat || this.Yandere.Carrying && this.Yandere.CurrentRagdoll.Concealed || this.Yandere.Dragging && this.Yandere.CurrentRagdoll.Concealed || this.Yandere.Schoolwear == 2 && (double) this.Yandere.transform.position.z < 30.0)
      {
    ...
    else
    {
      if (this.Guarding)
      {
        if ((double) this.Yandere.Bloodiness + (double) this.Yandere.GloveBlood > 0.0 && !this.Yandere.Paint)
          ...
          this.Witnessed = StudentWitnessType.Weapon;
        else if ((double) this.Yandere.Sanity < 66.6666564941406)
          this.Witnessed = StudentWitnessType.Insanity;
      }
      if (this.Witnessed == StudentWitnessType.Murder)
      {
  ...
  private void CheckForEndRaibaruEvent()
  {
    if (!((UnityEngine.Object) this.StudentManager.Students[46] == (UnityEngine.Object) null) && this.StudentManager.Students[46].Phase <= this.Phase)
      return;
    Debug.Log((object) "This code should only be allowed to run if Raibaru just finished mentoring the Martial Arts Club...");
    if ((UnityEngine.Object) this.FollowTarget != (UnityEngine.Object) null)
    {
      if (this.FollowTarget.Alive)
      {
  ...
  public void BecomeSleuth()
  {
    if (this.Club == ClubType.Newspaper)
      Debug.Log((object) ("Newspaper Club Member Student # " + this.StudentID.ToString() + " - " + this.Name + " - is being turned into a Sleuth."));
    else if (this.Club == ClubType.Photography)
      Debug.Log((object) ("Photography Club Member Student # " + this.StudentID.ToString() + " - " + this.Name + " - is being turned into a Sleuth."));
    else if (this.Club == ClubType.None)
      Debug.Log((object) ("Clubless Student # " + this.StudentID.ToString() + " - " + this.Name + " - is being turned into a Sleuth."));
    if (this.StudentManager.Eighties)
    {
