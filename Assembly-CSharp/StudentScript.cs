...
public class StudentScript : MonoBehaviour
{
	...
	// (get) Token: 0x06001DBC RID: 7612 RVA: 0x0016AB15 File Offset: 0x00168D15
	public bool Alive
	{
		get
		{
	...
	// Token: 0x06001DBD RID: 7613 RVA: 0x0016AB20 File Offset: 0x00168D20
	public void Start()
	{
	...
	// Token: 0x06001DBE RID: 7614 RVA: 0x0016DA2C File Offset: 0x0016BC2C
	...
	// (get) Token: 0x06001DBF RID: 7615 RVA: 0x0016DA50 File Offset: 0x0016BC50
	...
	// (get) Token: 0x06001DC0 RID: 7616 RVA: 0x0016DAA4 File Offset: 0x0016BCA4
	...
	// (get) Token: 0x06001DC1 RID: 7617 RVA: 0x0016DAFC File Offset: 0x0016BCFC
	...
	// (get) Token: 0x06001DC2 RID: 7618 RVA: 0x0016DB64 File Offset: 0x0016BD64
	...
	// (get) Token: 0x06001DC3 RID: 7619 RVA: 0x0016DCD4 File Offset: 0x0016BED4
	...
	// Token: 0x06001DC4 RID: 7620 RVA: 0x0016DDA0 File Offset: 0x0016BFA0
	...
	// Token: 0x06001DC5 RID: 7621 RVA: 0x0016DDE8 File Offset: 0x0016BFE8
	...
	// Token: 0x06001DC6 RID: 7622 RVA: 0x0016DF14 File Offset: 0x0016C114
	...
	// Token: 0x06001DC7 RID: 7623 RVA: 0x0016DFB0 File Offset: 0x0016C1B0
	...
	// Token: 0x06001DC8 RID: 7624 RVA: 0x0016E04B File Offset: 0x0016C24B
	public bool CanSeeObject(GameObject obj)
	{
		return this.CanSeeObject(obj, obj.transform.position);
	}

	// Token: 0x06001DC9 RID: 7625 RVA: 0x0016E060 File Offset: 0x0016C260
	private void Update()
	{
		if (!this.Stop)
		{
	...
	// Token: 0x06001DCA RID: 7626 RVA: 0x0016E174 File Offset: 0x0016C374
	...
	// Token: 0x06001DCB RID: 7627 RVA: 0x0016E760 File Offset: 0x0016C960
		...
		if (this.Routine)
		{
			...
			if (this.DistanceToDestination > this.TargetDistance)
			{
				if (this.Actions[this.Phase] == StudentActionType.Sleuth)
				{
					...
					else if (this.DistractionTarget != null && this.DistanceToDestination < 10f && (this.StudentManager.LockerRoomArea.bounds.Contains(this.DistractionTarget.transform.position) || this.StudentManager.MaleLockerRoomArea.bounds.Contains(this.DistractionTarget.transform.position)))
					{
						this.GetSleuthTarget();
					}
				}
			...
			else
			{
				...
				{
					bool flag = false;
					if ((this.Actions[this.Phase] == StudentActionType.Sleuth && this.StudentManager.SleuthPhase == 3 && !this.Meeting) || (this.Actions[this.Phase] == StudentActionType.Stalk || (this.Actions[this.Phase] == StudentActionType.Relax && this.CuriosityPhase == 1)) || (this.Actions[this.Phase] == StudentActionType.Guard && !this.Meeting))
					{
						this.TargetDistance = 2f;
						flag = true;
					}
	...
	// Token: 0x06001DCC RID: 7628 RVA: 0x00183D1C File Offset: 0x00181F1C
	...
	// Token: 0x06001DCD RID: 7629 RVA: 0x00183F3C File Offset: 0x0018213C
	...
	// Token: 0x06001DCE RID: 7630 RVA: 0x001840F4 File Offset: 0x001822F4
	...
	// Token: 0x06001DCF RID: 7631 RVA: 0x00184284 File Offset: 0x00182484
	...
	// Token: 0x06001DD0 RID: 7632 RVA: 0x00184574 File Offset: 0x00182774
	...
	// Token: 0x06001DD1 RID: 7633 RVA: 0x00185EB8 File Offset: 0x001840B8
	...
	// Token: 0x06001DD2 RID: 7634 RVA: 0x001867A0 File Offset: 0x001849A0
	...
	// Token: 0x06001DD3 RID: 7635 RVA: 0x00186984 File Offset: 0x00184B84
	private void UpdateTalkInput()
	{
		...
		if (this.Prompt.Circle[2].fillAmount == 0f || (this.Yandere.Sanity < 33.33333f && this.Yandere.CanMove && !this.Prompt.HideButton[2] && this.Prompt.InSight && this.Club != ClubType.Council && !this.Struggling && !this.Chasing && this.DistanceToPlayer < 1.4f && this.SeenByYandere() && this.StudentID > 1))
		{
			...
			Debug.Log("# of OriginalUniforms is: " + this.StudentManager.OriginalUniforms.ToString() + " and # of newUniforms is: " + this.StudentManager.NewUniforms.ToString());
	...
	// Token: 0x06001DD4 RID: 7636 RVA: 0x0018882C File Offset: 0x00186A2C
	...
	// Token: 0x06001DD5 RID: 7637 RVA: 0x00188F9C File Offset: 0x0018719C
	...
	// Token: 0x06001DD6 RID: 7638 RVA: 0x00189024 File Offset: 0x00187224
	...
	// Token: 0x06001DD7 RID: 7639 RVA: 0x001890F4 File Offset: 0x001872F4
	...
	// Token: 0x06001DD8 RID: 7640 RVA: 0x00189600 File Offset: 0x00187800
	...
	// Token: 0x06001DD9 RID: 7641 RVA: 0x0018B69C File Offset: 0x0018989C
	...
	// Token: 0x06001DDA RID: 7642 RVA: 0x0018B730 File Offset: 0x00189930
	...
	// Token: 0x06001DDB RID: 7643 RVA: 0x0018BBAC File Offset: 0x00189DAC
	...
	// Token: 0x06001DDC RID: 7644 RVA: 0x0018C060 File Offset: 0x0018A260
	...
	// Token: 0x06001DDD RID: 7645 RVA: 0x0018C47C File Offset: 0x0018A67C
	...
	// Token: 0x06001DDE RID: 7646 RVA: 0x0018C52C File Offset: 0x0018A72C
	...
	// Token: 0x06001DDF RID: 7647 RVA: 0x0018C9D8 File Offset: 0x0018ABD8
	...
	// Token: 0x06001DE0 RID: 7648 RVA: 0x0018CFFC File Offset: 0x0018B1FC
	...
	// Token: 0x06001DE1 RID: 7649 RVA: 0x0018D9C8 File Offset: 0x0018BBC8
	...
	// Token: 0x06001DE2 RID: 7650 RVA: 0x0018DB80 File Offset: 0x0018BD80
	...
	// Token: 0x06001DE3 RID: 7651 RVA: 0x0018DBE9 File Offset: 0x0018BDE9
	private void LookTowardsTarget(Vector3 target)
	{
		float timeScale = Time.timeScale;
	}

	// Token: 0x06001DE4 RID: 7652 RVA: 0x0018DBF8 File Offset: 0x0018BDF8
	...
	// Token: 0x06001DE5 RID: 7653 RVA: 0x0018E578 File Offset: 0x0018C778
	...
	// Token: 0x06001DE6 RID: 7654 RVA: 0x0018E634 File Offset: 0x0018C834
	...
	// Token: 0x06001DE7 RID: 7655 RVA: 0x0018EB10 File Offset: 0x0018CD10
	...
	// Token: 0x06001DE8 RID: 7656 RVA: 0x0018F4B8 File Offset: 0x0018D6B8
	...
	// Token: 0x06001DE9 RID: 7657 RVA: 0x0018F51C File Offset: 0x0018D71C
	...
	// Token: 0x06001DEA RID: 7658 RVA: 0x0018F5C4 File Offset: 0x0018D7C4
	...
	// Token: 0x06001DEB RID: 7659 RVA: 0x00190E50 File Offset: 0x0018F050
	...
	// Token: 0x06001DEC RID: 7660 RVA: 0x001910CC File Offset: 0x0018F2CC
	...
	// Token: 0x06001DED RID: 7661 RVA: 0x00192558 File Offset: 0x00190758
	...
	// Token: 0x06001DEE RID: 7662 RVA: 0x001925E0 File Offset: 0x001907E0
	...
	// Token: 0x06001DEF RID: 7663 RVA: 0x00192644 File Offset: 0x00190844
	...
	// Token: 0x06001DF0 RID: 7664 RVA: 0x001926F0 File Offset: 0x001908F0
	...
	// Token: 0x06001DF1 RID: 7665 RVA: 0x00192724 File Offset: 0x00190924
	...
	// Token: 0x06001DF2 RID: 7666 RVA: 0x00192978 File Offset: 0x00190B78
	...
	// Token: 0x06001DF3 RID: 7667 RVA: 0x001929F0 File Offset: 0x00190BF0
	...
	// Token: 0x06001DF4 RID: 7668 RVA: 0x0019321C File Offset: 0x0019141C
	public void GetWet()
	{
	...
	// Token: 0x06001DF5 RID: 7669 RVA: 0x00193600 File Offset: 0x00191800
	public void UnWet()
	{
		this.ID = 0;
		while (this.ID < this.LiquidEmitters.Length)
	...
	// Token: 0x06001DF6 RID: 7670 RVA: 0x0019364C File Offset: 0x0019184C
	...
	// Token: 0x06001DF7 RID: 7671 RVA: 0x00193698 File Offset: 0x00191898
	...
	// Token: 0x06001DF8 RID: 7672 RVA: 0x0019373C File Offset: 0x0019193C
	...
	// Token: 0x06001DF9 RID: 7673 RVA: 0x00193814 File Offset: 0x00191A14
	public void Combust()
	{
		this.Police.CorpseList[this.Police.Corpses] = this.Ragdoll;
		this.Police.Corpses++;
	...
	// Token: 0x06001DFA RID: 7674 RVA: 0x00193A2C File Offset: 0x00191C2C
	...
	// Token: 0x06001DFB RID: 7675 RVA: 0x00193B64 File Offset: 0x00191D64
	private void Nude()
	{
		if (!this.Male)
		{
	...
	// Token: 0x06001DFC RID: 7676 RVA: 0x00193DC8 File Offset: 0x00191FC8
	...
	// Token: 0x06001DFD RID: 7677 RVA: 0x00194368 File Offset: 0x00192568
	...
	// Token: 0x06001DFE RID: 7678 RVA: 0x001944FC File Offset: 0x001926FC
	public void Spook()
	{
		if (!this.Male)
		{
	...
	// Token: 0x06001DFF RID: 7679 RVA: 0x0019457C File Offset: 0x0019277C
	...
	// Token: 0x06001E00 RID: 7680 RVA: 0x001945D0 File Offset: 0x001927D0
	...
	// Token: 0x06001E01 RID: 7681 RVA: 0x00194664 File Offset: 0x00192864
	...
	// Token: 0x06001E02 RID: 7682 RVA: 0x00194760 File Offset: 0x00192960
	...
	// Token: 0x06001E03 RID: 7683 RVA: 0x001947BC File Offset: 0x001929BC
	...
	// Token: 0x06001E04 RID: 7684 RVA: 0x00194D48 File Offset: 0x00192F48
	...
	// Token: 0x06001E05 RID: 7685 RVA: 0x00194F40 File Offset: 0x00193140
	...
	// Token: 0x06001E06 RID: 7686 RVA: 0x0019506C File Offset: 0x0019326C
	...
	// Token: 0x06001E07 RID: 7687 RVA: 0x001950E4 File Offset: 0x001932E4
	...
	// Token: 0x06001E08 RID: 7688 RVA: 0x00195455 File Offset: 0x00193655
	...
	// Token: 0x06001E09 RID: 7689 RVA: 0x00195490 File Offset: 0x00193690
	...
	// Token: 0x06001E0A RID: 7690 RVA: 0x00195514 File Offset: 0x00193714
	...
	// Token: 0x06001E0B RID: 7691 RVA: 0x001956A8 File Offset: 0x001938A8
	...
	// (get) Token: 0x06001E0C RID: 7692 RVA: 0x001956FD File Offset: 0x001938FD
	...
	// Token: 0x06001E0D RID: 7693 RVA: 0x00195708 File Offset: 0x00193908
	private bool LovedOneIsTargeted(int yandereTargetID)
	{
		...
		if (!this.StudentManager.Eighties)
		{
			bool flag2 = this.InCouple && this.CoupleID == yandereTargetID;
	...
	// Token: 0x06001E0E RID: 7694 RVA: 0x00195870 File Offset: 0x00193A70
	private void Pose()
	{
	...
	// Token: 0x06001E0F RID: 7695 RVA: 0x001959AC File Offset: 0x00193BAC
	...
	// Token: 0x06001E10 RID: 7696 RVA: 0x00195B00 File Offset: 0x00193D00
	...
	// Token: 0x06001E11 RID: 7697 RVA: 0x00195C84 File Offset: 0x00193E84
	...
	// Token: 0x06001E12 RID: 7698 RVA: 0x00195D0C File Offset: 0x00193F0C
	...
	// Token: 0x06001E13 RID: 7699 RVA: 0x00195D78 File Offset: 0x00193F78
	...
	// Token: 0x06001E14 RID: 7700 RVA: 0x00195E64 File Offset: 0x00194064
	...
	// Token: 0x06001E15 RID: 7701 RVA: 0x00195F5C File Offset: 0x0019415C
	...
	// Token: 0x06001E16 RID: 7702 RVA: 0x00196160 File Offset: 0x00194360
	public void Shove()
	{
	...
	// Token: 0x06001E17 RID: 7703 RVA: 0x00196628 File Offset: 0x00194828
	...
	// Token: 0x06001E18 RID: 7704 RVA: 0x001967A8 File Offset: 0x001949A8
	public void Spray()
	{
	...
	// Token: 0x06001E19 RID: 7705 RVA: 0x00196CEC File Offset: 0x00194EEC
	...
	// Token: 0x06001E1A RID: 7706 RVA: 0x00196E04 File Offset: 0x00195004
	...
	// Token: 0x06001E1B RID: 7707 RVA: 0x00196ED0 File Offset: 0x001950D0
	...
	// Token: 0x06001E1C RID: 7708 RVA: 0x00197044 File Offset: 0x00195244
	...
	// Token: 0x06001E1D RID: 7709 RVA: 0x001971B8 File Offset: 0x001953B8
	...
	// Token: 0x06001E1E RID: 7710 RVA: 0x001973DC File Offset: 0x001955DC
	...
	// Token: 0x06001E1F RID: 7711 RVA: 0x00197424 File Offset: 0x00195624
	...
	// Token: 0x06001E20 RID: 7712 RVA: 0x00197708 File Offset: 0x00195908
	...
	// Token: 0x06001E21 RID: 7713 RVA: 0x0019775C File Offset: 0x0019595C
	...
	// Token: 0x06001E22 RID: 7714 RVA: 0x001979B0 File Offset: 0x00195BB0
	...
	// Token: 0x06001E23 RID: 7715 RVA: 0x00197A70 File Offset: 0x00195C70
	...
	// Token: 0x06001E24 RID: 7716 RVA: 0x00197D08 File Offset: 0x00195F08
	...
	// Token: 0x06001E25 RID: 7717 RVA: 0x00197E20 File Offset: 0x00196020
	...
	// Token: 0x06001E26 RID: 7718 RVA: 0x00198144 File Offset: 0x00196344
	...
	// Token: 0x06001E27 RID: 7719 RVA: 0x0019836C File Offset: 0x0019656C
	...
	// Token: 0x06001E28 RID: 7720 RVA: 0x00198438 File Offset: 0x00196638
	...
	// Token: 0x06001E29 RID: 7721 RVA: 0x00198840 File Offset: 0x00196A40
	...
	// Token: 0x06001E2A RID: 7722 RVA: 0x00198F84 File Offset: 0x00197184
	...
	// Token: 0x06001E2B RID: 7723 RVA: 0x0019902C File Offset: 0x0019722C
	...
	// Token: 0x06001E2C RID: 7724 RVA: 0x001990E8 File Offset: 0x001972E8
	...
	// Token: 0x06001E2D RID: 7725 RVA: 0x00199938 File Offset: 0x00197B38
	...
	// Token: 0x06001E2E RID: 7726 RVA: 0x00199C60 File Offset: 0x00197E60
	...
	// Token: 0x06001E2F RID: 7727 RVA: 0x00199E94 File Offset: 0x00198094
	...
	// Token: 0x06001E30 RID: 7728 RVA: 0x0019A018 File Offset: 0x00198218
	...
	// Token: 0x06001E31 RID: 7729 RVA: 0x0019A04C File Offset: 0x0019824C
	...
	// Token: 0x06001E32 RID: 7730 RVA: 0x0019A2E0 File Offset: 0x001984E0
	...
	// Token: 0x06001E33 RID: 7731 RVA: 0x0019A497 File Offset: 0x00198697
	...
	// Token: 0x06001E34 RID: 7732 RVA: 0x0019A4C4 File Offset: 0x001986C4
	...
	// Token: 0x06001E35 RID: 7733 RVA: 0x0019A52E File Offset: 0x0019872E
	...
	// Token: 0x06001E36 RID: 7734 RVA: 0x0019A568 File Offset: 0x00198768
	...
	// Token: 0x06001E37 RID: 7735 RVA: 0x0019A704 File Offset: 0x00198904
	...
	// Token: 0x06001E38 RID: 7736 RVA: 0x0019A794 File Offset: 0x00198994
	...
	// Token: 0x06001E39 RID: 7737 RVA: 0x0019A850 File Offset: 0x00198A50
	...
	// Token: 0x06001E3A RID: 7738 RVA: 0x0019A8D4 File Offset: 0x00198AD4
	...
	// Token: 0x06001E3B RID: 7739 RVA: 0x0019A928 File Offset: 0x00198B28
	...
	// Token: 0x06001E3C RID: 7740 RVA: 0x0019A9A0 File Offset: 0x00198BA0
	...
	// Token: 0x06001E3D RID: 7741 RVA: 0x0019AA48 File Offset: 0x00198C48
	...
	// Token: 0x06001E3E RID: 7742 RVA: 0x0019AADC File Offset: 0x00198CDC
	...
	// Token: 0x06001E3F RID: 7743 RVA: 0x0019ACC0 File Offset: 0x00198EC0
	...
	// Token: 0x06001E40 RID: 7744 RVA: 0x0019AE88 File Offset: 0x00199088
	...
	// Token: 0x06001E41 RID: 7745 RVA: 0x0019AEEC File Offset: 0x001990EC
	...
	// Token: 0x06001E42 RID: 7746 RVA: 0x0019AF30 File Offset: 0x00199130
	...
	// Token: 0x06001E43 RID: 7747 RVA: 0x0019B398 File Offset: 0x00199598
	...
	// Token: 0x06001E44 RID: 7748 RVA: 0x0019B73C File Offset: 0x0019993C
	...
	// Token: 0x06001E45 RID: 7749 RVA: 0x0019B848 File Offset: 0x00199A48
	...
	// Token: 0x06001E46 RID: 7750 RVA: 0x0019B8F0 File Offset: 0x00199AF0
