...
public class StudentScript : MonoBehaviour
{
	...
	// (get) Token: 0x06001DC3 RID: 7619 RVA: 0x0016C05D File Offset: 0x0016A25D
	public bool Alive
	{
		get
		{
	...
	// Token: 0x06001DC4 RID: 7620 RVA: 0x0016C068 File Offset: 0x0016A268
	public void Start()
	{
	...
	// Token: 0x06001DC5 RID: 7621 RVA: 0x0016EF74 File Offset: 0x0016D174
	...
	// (get) Token: 0x06001DC6 RID: 7622 RVA: 0x0016EF98 File Offset: 0x0016D198
	...
	// (get) Token: 0x06001DC7 RID: 7623 RVA: 0x0016EFEC File Offset: 0x0016D1EC
	...
	// (get) Token: 0x06001DC8 RID: 7624 RVA: 0x0016F068 File Offset: 0x0016D268
	...
	// (get) Token: 0x06001DC9 RID: 7625 RVA: 0x0016F0D0 File Offset: 0x0016D2D0
	...
	// (get) Token: 0x06001DCA RID: 7626 RVA: 0x0016F240 File Offset: 0x0016D440
	...
	// Token: 0x06001DCB RID: 7627 RVA: 0x0016F30C File Offset: 0x0016D50C
	...
	// Token: 0x06001DCC RID: 7628 RVA: 0x0016F354 File Offset: 0x0016D554
	...
	// Token: 0x06001DCD RID: 7629 RVA: 0x0016F480 File Offset: 0x0016D680
	...
	// Token: 0x06001DCE RID: 7630 RVA: 0x0016F51C File Offset: 0x0016D71C
	...
	// Token: 0x06001DCF RID: 7631 RVA: 0x0016F5B7 File Offset: 0x0016D7B7
	public bool CanSeeObject(GameObject obj)
	{
		return this.CanSeeObject(obj, obj.transform.position);
	}

	// Token: 0x06001DD0 RID: 7632 RVA: 0x0016F5CC File Offset: 0x0016D7CC
	private void Update()
	{
		if (!this.Stop)
		{
	...
	// Token: 0x06001DD1 RID: 7633 RVA: 0x0016F6E0 File Offset: 0x0016D8E0
	...
	// Token: 0x06001DD2 RID: 7634 RVA: 0x0016FCCC File Offset: 0x0016DECC
										...
										else
										{
											...
											else
											{
												...
												if (this.Actions[this.Phase] == StudentActionType.UpdateAppearance)
												{
													...
													scheduleBlock19.destination = "Club";
													scheduleBlock19.action = "Club";
													this.GetDestinations();
													this.CurrentDestination = this.Destinations[this.Phase];
													this.Pathfinding.target = this.Destinations[this.Phase];
													...
													for (int j = 1; j < 6; j++)
													{
														ScheduleBlock scheduleBlock20 = this.StudentManager.Students[80 + j].ScheduleBlocks[4];
														scheduleBlock20.destination = "Shock";
														scheduleBlock20.action = "Shock";
												...
												if (this.Actions[this.Phase] == StudentActionType.LightFire)
												{
													...
													else if (this.PyroPhase == 4)
													{
														...
														scheduleBlock21.action = "Socialize";
														this.GetDestinations();
														this.Pathfinding.target = this.Destinations[this.Phase];
														this.CurrentDestination = this.Destinations[this.Phase];
														this.PyroPhase = 1;
		...
		else
		{
			...
			if (this.EndSearch)
			{
				...
				if (this.PatrolTimer > 5f)
				{
					...
					scheduleBlock25.action = "Hangout";
					this.GetDestinations();
			...
			if (this.SeekingMedicine)
			{
				...
				else if (this.SeekMedicinePhase != 3)
				{
					...
					else if (this.SeekMedicinePhase == 5)
					{
						...
						scheduleBlock26.destination = "InfirmarySeat";
						scheduleBlock26.action = "Relax";
						this.GetDestinations();
						this.CurrentDestination = this.Destinations[this.Phase];
						this.Pathfinding.target = this.Destinations[this.Phase];
						this.Pathfinding.speed = 2f;
	...
	// Token: 0x06001DD3 RID: 7635 RVA: 0x00185280 File Offset: 0x00183480
	...
	// Token: 0x06001DD4 RID: 7636 RVA: 0x001854A0 File Offset: 0x001836A0
	...
	// Token: 0x06001DD5 RID: 7637 RVA: 0x00185658 File Offset: 0x00183858
	...
	// Token: 0x06001DD6 RID: 7638 RVA: 0x001857E8 File Offset: 0x001839E8
	...
	// Token: 0x06001DD7 RID: 7639 RVA: 0x00185AD8 File Offset: 0x00183CD8
	...
	// Token: 0x06001DD8 RID: 7640 RVA: 0x00187428 File Offset: 0x00185628
	...
	// Token: 0x06001DD9 RID: 7641 RVA: 0x00187D10 File Offset: 0x00185F10
	...
	// Token: 0x06001DDA RID: 7642 RVA: 0x00187EF4 File Offset: 0x001860F4
	...
	// Token: 0x06001DDB RID: 7643 RVA: 0x00189DC0 File Offset: 0x00187FC0
	...
	// Token: 0x06001DDC RID: 7644 RVA: 0x0018A530 File Offset: 0x00188730
	...
	// Token: 0x06001DDD RID: 7645 RVA: 0x0018A5B8 File Offset: 0x001887B8
	...
	// Token: 0x06001DDE RID: 7646 RVA: 0x0018A688 File Offset: 0x00188888
	...
	// Token: 0x06001DDF RID: 7647 RVA: 0x0018AB94 File Offset: 0x00188D94
	...
	// Token: 0x06001DE0 RID: 7648 RVA: 0x0018CC30 File Offset: 0x0018AE30
	...
	// Token: 0x06001DE1 RID: 7649 RVA: 0x0018CCC4 File Offset: 0x0018AEC4
	...
	// Token: 0x06001DE2 RID: 7650 RVA: 0x0018D140 File Offset: 0x0018B340
	...
	// Token: 0x06001DE3 RID: 7651 RVA: 0x0018D5F4 File Offset: 0x0018B7F4
	...
	// Token: 0x06001DE4 RID: 7652 RVA: 0x0018DA10 File Offset: 0x0018BC10
	...
	// Token: 0x06001DE5 RID: 7653 RVA: 0x0018DAC0 File Offset: 0x0018BCC0
	...
	// Token: 0x06001DE6 RID: 7654 RVA: 0x0018DF6C File Offset: 0x0018C16C
	...
	// Token: 0x06001DE7 RID: 7655 RVA: 0x0018E590 File Offset: 0x0018C790
	...
	// Token: 0x06001DE8 RID: 7656 RVA: 0x0018EF5C File Offset: 0x0018D15C
	...
	// Token: 0x06001DE9 RID: 7657 RVA: 0x0018F114 File Offset: 0x0018D314
	...
	// Token: 0x06001DEA RID: 7658 RVA: 0x0018F17D File Offset: 0x0018D37D
	private void LookTowardsTarget(Vector3 target)
	{
		float timeScale = Time.timeScale;
	}

	// Token: 0x06001DEB RID: 7659 RVA: 0x0018F18C File Offset: 0x0018D38C
	...
	// Token: 0x06001DEC RID: 7660 RVA: 0x0018FB0C File Offset: 0x0018DD0C
	...
	// Token: 0x06001DED RID: 7661 RVA: 0x0018FBC8 File Offset: 0x0018DDC8
	...
	// Token: 0x06001DEE RID: 7662 RVA: 0x001900A4 File Offset: 0x0018E2A4
	...
	// Token: 0x06001DEF RID: 7663 RVA: 0x00190A4C File Offset: 0x0018EC4C
	...
	// Token: 0x06001DF0 RID: 7664 RVA: 0x00190AB0 File Offset: 0x0018ECB0
	...
	// Token: 0x06001DF1 RID: 7665 RVA: 0x00190B58 File Offset: 0x0018ED58
	...
	// Token: 0x06001DF2 RID: 7666 RVA: 0x001923E4 File Offset: 0x001905E4
	...
	// Token: 0x06001DF3 RID: 7667 RVA: 0x00192660 File Offset: 0x00190860
	...
	// Token: 0x06001DF4 RID: 7668 RVA: 0x00193AEC File Offset: 0x00191CEC
	...
	// Token: 0x06001DF5 RID: 7669 RVA: 0x00193B74 File Offset: 0x00191D74
	...
	// Token: 0x06001DF6 RID: 7670 RVA: 0x00193BD8 File Offset: 0x00191DD8
	...
	// Token: 0x06001DF7 RID: 7671 RVA: 0x00193C84 File Offset: 0x00191E84
	...
	// Token: 0x06001DF8 RID: 7672 RVA: 0x00193CB8 File Offset: 0x00191EB8
	...
	// Token: 0x06001DF9 RID: 7673 RVA: 0x00193F0C File Offset: 0x0019210C
	...
	// Token: 0x06001DFA RID: 7674 RVA: 0x00193F84 File Offset: 0x00192184
	...
	// Token: 0x06001DFB RID: 7675 RVA: 0x001947B0 File Offset: 0x001929B0
	public void GetWet()
	{
	...
	// Token: 0x06001DFC RID: 7676 RVA: 0x00194B94 File Offset: 0x00192D94
	public void UnWet()
	{
		this.ID = 0;
		while (this.ID < this.LiquidEmitters.Length)
	...
	// Token: 0x06001DFD RID: 7677 RVA: 0x00194BE0 File Offset: 0x00192DE0
	...
	// Token: 0x06001DFE RID: 7678 RVA: 0x00194C2C File Offset: 0x00192E2C
	...
	// Token: 0x06001DFF RID: 7679 RVA: 0x00194CD0 File Offset: 0x00192ED0
	...
	// Token: 0x06001E00 RID: 7680 RVA: 0x00194DA8 File Offset: 0x00192FA8
	public void Combust()
	{
		this.Police.CorpseList[this.Police.Corpses] = this.Ragdoll;
		this.Police.Corpses++;
	...
	// Token: 0x06001E01 RID: 7681 RVA: 0x00194FC0 File Offset: 0x001931C0
	...
	// Token: 0x06001E02 RID: 7682 RVA: 0x001950F8 File Offset: 0x001932F8
	private void Nude()
	{
		if (!this.Male)
		{
	...
	// Token: 0x06001E03 RID: 7683 RVA: 0x0019535C File Offset: 0x0019355C
	...
	// Token: 0x06001E04 RID: 7684 RVA: 0x001958F4 File Offset: 0x00193AF4
	...
	// Token: 0x06001E05 RID: 7685 RVA: 0x00195A88 File Offset: 0x00193C88
	public void Spook()
	{
		if (!this.Male)
		{
	...
	// Token: 0x06001E06 RID: 7686 RVA: 0x00195B08 File Offset: 0x00193D08
	...
	// Token: 0x06001E07 RID: 7687 RVA: 0x00195B5C File Offset: 0x00193D5C
	...
	// Token: 0x06001E08 RID: 7688 RVA: 0x00195BF0 File Offset: 0x00193DF0
	...
	// Token: 0x06001E09 RID: 7689 RVA: 0x00195CEC File Offset: 0x00193EEC
	...
	// Token: 0x06001E0A RID: 7690 RVA: 0x00195D48 File Offset: 0x00193F48
	...
	// Token: 0x06001E0B RID: 7691 RVA: 0x001962D4 File Offset: 0x001944D4
	...
	// Token: 0x06001E0C RID: 7692 RVA: 0x001964CC File Offset: 0x001946CC
	...
	// Token: 0x06001E0D RID: 7693 RVA: 0x001965F8 File Offset: 0x001947F8
	...
	// Token: 0x06001E0E RID: 7694 RVA: 0x00196670 File Offset: 0x00194870
	...
	// Token: 0x06001E0F RID: 7695 RVA: 0x001969E1 File Offset: 0x00194BE1
	...
	// Token: 0x06001E10 RID: 7696 RVA: 0x00196A1C File Offset: 0x00194C1C
	...
	// Token: 0x06001E11 RID: 7697 RVA: 0x00196AA0 File Offset: 0x00194CA0
	...
	// Token: 0x06001E12 RID: 7698 RVA: 0x00196C34 File Offset: 0x00194E34
	...
	// (get) Token: 0x06001E13 RID: 7699 RVA: 0x00196C89 File Offset: 0x00194E89
	...
	// Token: 0x06001E14 RID: 7700 RVA: 0x00196C94 File Offset: 0x00194E94
	...
	// Token: 0x06001E15 RID: 7701 RVA: 0x00196DFC File Offset: 0x00194FFC
	private void Pose()
	{
	...
	// Token: 0x06001E16 RID: 7702 RVA: 0x00196F38 File Offset: 0x00195138
	...
	// Token: 0x06001E17 RID: 7703 RVA: 0x0019708C File Offset: 0x0019528C
	...
	// Token: 0x06001E18 RID: 7704 RVA: 0x00197210 File Offset: 0x00195410
	...
	// Token: 0x06001E19 RID: 7705 RVA: 0x00197298 File Offset: 0x00195498
	...
	// Token: 0x06001E1A RID: 7706 RVA: 0x00197304 File Offset: 0x00195504
	...
	// Token: 0x06001E1B RID: 7707 RVA: 0x001973F0 File Offset: 0x001955F0
	...
	// Token: 0x06001E1C RID: 7708 RVA: 0x001974E8 File Offset: 0x001956E8
	...
	// Token: 0x06001E1D RID: 7709 RVA: 0x001976EC File Offset: 0x001958EC
	public void Shove()
	{
	...
	// Token: 0x06001E1E RID: 7710 RVA: 0x00197BB4 File Offset: 0x00195DB4
	...
	// Token: 0x06001E1F RID: 7711 RVA: 0x00197D34 File Offset: 0x00195F34
	public void Spray()
	{
	...
	// Token: 0x06001E20 RID: 7712 RVA: 0x00198278 File Offset: 0x00196478
	...
	// Token: 0x06001E21 RID: 7713 RVA: 0x00198390 File Offset: 0x00196590
	...
	// Token: 0x06001E22 RID: 7714 RVA: 0x0019845C File Offset: 0x0019665C
	...
	// Token: 0x06001E23 RID: 7715 RVA: 0x001985D0 File Offset: 0x001967D0
	...
	// Token: 0x06001E24 RID: 7716 RVA: 0x00198744 File Offset: 0x00196944
	...
	// Token: 0x06001E25 RID: 7717 RVA: 0x00198968 File Offset: 0x00196B68
	...
	// Token: 0x06001E26 RID: 7718 RVA: 0x001989B0 File Offset: 0x00196BB0
	...
	// Token: 0x06001E27 RID: 7719 RVA: 0x00198C94 File Offset: 0x00196E94
	...
	// Token: 0x06001E28 RID: 7720 RVA: 0x00198CE8 File Offset: 0x00196EE8
	...
	// Token: 0x06001E29 RID: 7721 RVA: 0x00198F3C File Offset: 0x0019713C
	...
	// Token: 0x06001E2A RID: 7722 RVA: 0x00198FFC File Offset: 0x001971FC
	...
	// Token: 0x06001E2B RID: 7723 RVA: 0x00199294 File Offset: 0x00197494
	...
	// Token: 0x06001E2C RID: 7724 RVA: 0x001993AC File Offset: 0x001975AC
	...
	// Token: 0x06001E2D RID: 7725 RVA: 0x001996D0 File Offset: 0x001978D0
	...
	// Token: 0x06001E2E RID: 7726 RVA: 0x001998F8 File Offset: 0x00197AF8
	...
	// Token: 0x06001E2F RID: 7727 RVA: 0x001999C4 File Offset: 0x00197BC4
	...
	// Token: 0x06001E30 RID: 7728 RVA: 0x00199DCC File Offset: 0x00197FCC
	...
	// Token: 0x06001E31 RID: 7729 RVA: 0x0019A510 File Offset: 0x00198710
	...
	// Token: 0x06001E32 RID: 7730 RVA: 0x0019A5B8 File Offset: 0x001987B8
	...
	// Token: 0x06001E33 RID: 7731 RVA: 0x0019A674 File Offset: 0x00198874
	...
	// Token: 0x06001E34 RID: 7732 RVA: 0x0019AEC4 File Offset: 0x001990C4
	...
	// Token: 0x06001E35 RID: 7733 RVA: 0x0019B1EC File Offset: 0x001993EC
	...
	// Token: 0x06001E36 RID: 7734 RVA: 0x0019B420 File Offset: 0x00199620
	...
	// Token: 0x06001E37 RID: 7735 RVA: 0x0019B5A4 File Offset: 0x001997A4
	...
	// Token: 0x06001E38 RID: 7736 RVA: 0x0019B5D8 File Offset: 0x001997D8
	...
	// Token: 0x06001E39 RID: 7737 RVA: 0x0019B86C File Offset: 0x00199A6C
	...
	// Token: 0x06001E3A RID: 7738 RVA: 0x0019BA23 File Offset: 0x00199C23
	...
	// Token: 0x06001E3B RID: 7739 RVA: 0x0019BA50 File Offset: 0x00199C50
	...
	// Token: 0x06001E3C RID: 7740 RVA: 0x0019BABA File Offset: 0x00199CBA
	...
	// Token: 0x06001E3D RID: 7741 RVA: 0x0019BAF4 File Offset: 0x00199CF4
	...
	// Token: 0x06001E3E RID: 7742 RVA: 0x0019BC90 File Offset: 0x00199E90
	...
	// Token: 0x06001E3F RID: 7743 RVA: 0x0019BD20 File Offset: 0x00199F20
	...
	// Token: 0x06001E40 RID: 7744 RVA: 0x0019BDDC File Offset: 0x00199FDC
	...
	// Token: 0x06001E41 RID: 7745 RVA: 0x0019BE60 File Offset: 0x0019A060
	...
	// Token: 0x06001E42 RID: 7746 RVA: 0x0019BEB4 File Offset: 0x0019A0B4
	...
	// Token: 0x06001E43 RID: 7747 RVA: 0x0019BF2C File Offset: 0x0019A12C
	...
	// Token: 0x06001E44 RID: 7748 RVA: 0x0019BFD4 File Offset: 0x0019A1D4
	...
	// Token: 0x06001E46 RID: 7750 RVA: 0x0019C24C File Offset: 0x0019A44C
	...
	// Token: 0x06001E47 RID: 7751 RVA: 0x0019C414 File Offset: 0x0019A614
	...
	// Token: 0x06001E48 RID: 7752 RVA: 0x0019C478 File Offset: 0x0019A678
	...
	// Token: 0x06001E49 RID: 7753 RVA: 0x0019C4BC File Offset: 0x0019A6BC
	...
	// Token: 0x06001E4A RID: 7754 RVA: 0x0019C924 File Offset: 0x0019AB24
	...
	// Token: 0x06001E4B RID: 7755 RVA: 0x0019CCDC File Offset: 0x0019AEDC
	...
	// Token: 0x06001E4C RID: 7756 RVA: 0x0019CDE8 File Offset: 0x0019AFE8
	...
	// Token: 0x06001E4D RID: 7757 RVA: 0x0019CE90 File Offset: 0x0019B090
	...
	// Token: 0x06001E4E RID: 7758 RVA: 0x0019CF38 File Offset: 0x0019B138
