...
{
	// Token: 0x0600138B RID: 5003 RVA: 0x000B3AD0 File Offset: 0x000B1CD0
	private void Start()
	{
	...
	// Token: 0x0600138C RID: 5004 RVA: 0x000B3B6C File Offset: 0x000B1D6C
	private void Update()
	{
		if (!this.Show)
		{
				...
				if (this.ClubLeader)
				{
					if (this.Selected != 0 && this.ClubShadow[this.Selected].color.a == 0f)
					{
						...
						else if (this.Selected == 2)
						{
							...
							if (this.ClubManager.QuitClub[(int)this.Yandere.TargetStudent.Club])
							{
	...
	// Token: 0x0600138D RID: 5005 RVA: 0x000B562C File Offset: 0x000B382C
	public void HideShadows()
	{
		...
		if (this.Yandere.ClubAttire || this.Yandere.Mask != null || this.Yandere.Gloves != null || (this.Yandere.Container != null && this.Yandere.Container.CelloCase))
		{
	...
	// Token: 0x0600138E RID: 5006 RVA: 0x000B6E88 File Offset: 0x000B5088
	...
	// Token: 0x0600138F RID: 5007 RVA: 0x000B749C File Offset: 0x000B569C
	public void End()
	{
